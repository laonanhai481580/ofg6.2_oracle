...
<script type="text/javascript">
		...
		var params = {};
	 	function hide(obj){
	 		...
	 		var url="${aftersalesctx}/far/hiddenState.htm?id="+id+"&&type=Y";
...
<body onclick="$('#sysTableDiv').hide(); $('#styleList').hide();">
	<script type="text/javascript">
		var secMenu="far";
		var thirdMenu="far_analysis_list_hide";
	</script>
	...
	<div class="ui-layout-center">
		<div class="opt-body">
			...
			<div class="opt-btn">
				...
				<security:authorize ifAnyGranted="AFS_FAR_ANALYSIS_EXPORT_HIDE">
					<button class='btn'
						onclick="iMatrix.export_Data('${actionBaseCtx}/export-hide.htm');">
						<span><span><b class="btn-icons btn-icons-export"></b>导出</span></span>
					</button>
				</security:authorize>
				<security:authorize ifAnyGranted="AFS_FAR_ANALYSIS_HIDE">
			...
			<div id="opt-content">
				<form id="contentForm" name="contentForm" method="post" action="">
					<grid:jqGrid gridId="list" url="${actionBaseCtx}/hide-list-datas.htm"
						submitForm="defaultForm" code="AFS_FAR_ANALYSIS"></grid:jqGrid>
				</form>
			</div>
		</div>
	</div>
