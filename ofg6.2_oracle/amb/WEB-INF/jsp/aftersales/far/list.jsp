...
<script type="text/javascript">
		...
		function click(cellvalue, options, rowObject){	
	 	...
	 	function hide(obj){
	 		...
	 		var url="${aftersalesctx}/far/hiddenState.htm?id="+id+"&&type=N";
...
<body onclick="$('#sysTableDiv').hide(); $('#styleList').hide();">
	<script type="text/javascript">
		var secMenu="far";
		var thirdMenu="far_analysis_list";
	</script>
	...
	<div class="ui-layout-center">
		<div class="opt-body">
			...
			<div class="opt-btn">
				...
				<security:authorize ifAnyGranted="AFS_FAR_ANALYSIS_DELETE">
				...
				<security:authorize ifAnyGranted="AFS_FAR_ANALYSIS_EXPORT">
					<button class='btn'
