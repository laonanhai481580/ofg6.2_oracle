	...
	<script type="text/javascript">
		...
		var params = {};
	 	function hide(obj){
	 		...
	 		var url="${aftersalesctx}/lar/hiddenState.htm?id="+id+"&&type=Y";
		...
		<div class="opt-body">
			...
			<aa:zone name="main">
				<div class="opt-btn">
					...
					<security:authorize ifAnyGranted="AFS_LAR_DATA_EXPORT_HIDE">
						<button class="btn" onclick="iMatrix.export_Data('${aftersalesctx}/lar/export-hide.htm');"><span><span><b class="btn-icons btn-icons-export"></b>导出</span></span></button>
					</security:authorize>
				...
				<div id="opt-content" >
					<form id="contentForm" name="contentForm" method="post"  action="">
						<grid:jqGrid gridId="list" url="${aftersalesctx}/lar/hide-list-datas.htm" submitForm="defaultForm" code="AFS_LAR_DATA" ></grid:jqGrid>
					</form>
				</div>
			</aa:zone>
		</div>
