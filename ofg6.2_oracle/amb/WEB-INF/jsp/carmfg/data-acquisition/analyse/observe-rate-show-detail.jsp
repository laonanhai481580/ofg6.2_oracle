		...
		<div class="opt-body">
			...
			<div id="opt-content">
				<form id="contentForm" name="contentForm" method="post"  action="">
					<grid:jqGrid gridId="cumtomerList"  url="${mfgctx}/data-acquisition/analyse/observe-rate-detail-datas.htm?searchParams=${searchParams}" code="MFG_IPQC_AUDIT" pageName="page"></grid:jqGrid>
				</form>
			</div>
		</div>
	</div>
