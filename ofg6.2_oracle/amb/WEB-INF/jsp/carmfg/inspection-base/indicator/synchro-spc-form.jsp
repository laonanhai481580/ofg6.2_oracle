...
<head>
	...
	function submitForm(){
		...
		if(date1&&date2&&date1>date2){
			...
			var url = "${mfgctx}/inspection-base/indicator/synchro-check-datas.htm?indicatorId="+<%=request.getParameter("indicatorId")%>;
	...
	function delRows(){
		...
		var featureId = $("#qualityFeature").val();
...
<body>
	<div class="opt-body">
		<div class="opt-btn">
		<%-- <security:authorize ifAnyGranted="MFG_SYNCHRO_SPC"> --%>
