...
<!-- 			<td style="width:80px;text-align:center;border-top:0px;">分类</td> -->
			...
			<td style="width:65px;text-align:center;border-top:0px;">检验数量</td>
			...
			<td style="width:<%=max*37 + 50%>px;padding:0px;border-top:0px;text-align: center;" id="checkItemsHeader">
				检验记录
			</td>
			<td style="width:80px;text-align:center;border-top:0px;">检验仪器编号</td>
			...
			<td style="width:60px;text-align: center;border-top:0px;">验证模式</td>
			<td style="width:60px;text-align: center;border-top:0px;">测试组ID</td>
			<td style="width:80px;text-align: center;border-top:0px;">备注</td>
		 	<!-- <td style="width:100px;text-align: center;border-top:0px;">附件</td> 
			<td style="width:150px;text-align: center;border-top:0px;">测试大项</td> -->
	...
	<tbody>
		<%
			...
			for(MfgCheckItem checkItem : checkItems){
				//System.out.println(checkItem.getConclusion());
				flag++;
		...
		%>
				...
				<td style="text-align: center;" itemName="<%=checkItem.getCheckItemName()%>"  tdShow="<%=isShow%>">			
					...
					<input type="hidden" fieldName="spcSampleIds" name="spcSampleIds" value="<%=checkItem.getSpcSampleIds()==null?"":checkItem.getSpcSampleIds()%>"/>					
...
<%-- 					<%=checkItem.getFeatureId()==null?"":checkItem.getFeatureId() %> --%>
				...
				<td style="text-align: center;border-right:0px;" itemName="<%=checkItem.getCheckItemName()%>"  tdShow="<%=isShow%>">
			 	...
			 	<td style="text-align: center;" itemName="<%=checkItem.getCheckItemName()%>"  tdShow="<%=isShow%>">
				   <select name="a<%=flag %>_isValidate" style="width:95%;"   itemName="<%=checkItem.getCheckItemName()%>"   fieldname="isValidate" >
				   		<option  <%if(checkItem.getIsValidate()==null||checkItem.getIsValidate().equals("")){%> selected="selected" <%}%> value="" ></option>
					    <option  <%if(checkItem.getIsValidate()!=null&&checkItem.getIsValidate().equals("是")){%> selected="selected" <%}%> value="是">是</option>
					    <option  <%if(checkItem.getIsValidate()!=null&&checkItem.getIsValidate().equals("否")){%> selected="selected" <%}%> value="否" >否</option>					    
				   </select>
				</td>
				<td style="text-align: center;" itemName="<%=checkItem.getCheckItemName()%>"  tdShow="<%=isShow%>">
					<input style="width:95%;padding:0px;text-align:center;" fieldName="testIds" name="a<%=flag %>_testIds" value="<%=checkItem.getTestIds()==null?"": checkItem.getTestIds() %>"></input>
				</td>
				<td style="text-align: center;" itemName="<%=checkItem.getCheckItemName()%>"  tdShow="<%=isShow%>">
					<input style="width:95%;padding:0px;text-align:center;float: left;" fieldName="remark" name="a<%=flag %>_remark" value="<%=checkItem.getRemark()==null?"": checkItem.getRemark()%>" ></input>
				</td>
