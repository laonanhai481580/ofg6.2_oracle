...
<head>
	...
	function hide(obj){
 		...
 		function(data){
 			  window.location.reload(href='${mfgctx}/inspection/made-inspection/patrol-list.htm');
			  alert("修改成功");
 		});
	}
	</script>
	...
	<div class="ui-layout-center">
			<div class="opt-body">
				<aa:zone name="main">
					...
					<security:authorize ifAnyGranted="made-patrol-inspection-input">
					...
					<security:authorize ifAnyGranted="made-partol-inspection-delete">
					...
					<security:authorize ifAnyGranted="made-partol-inspection-exports">
					<button  class='btn' onclick="iMatrix.export_Data('${mfgctx}/inspection/made-inspection/patrol-exports.htm');" type="button"><span><span><b class="btn-icons btn-icons-export"></b>导出</span></span></button>
					</security:authorize>
					...
					<div id="opt-content">
						<form id="contentForm" name="contentForm" method="post" action="">
							<grid:jqGrid gridId="dynamicInspection"  url="${mfgctx}/inspection/made-inspection/patrol-list-datas.htm" code="MFG_PATROL_INSPECTION_REPORT" pageName="page"></grid:jqGrid>
						</form>
					</div>
				</aa:zone>
			</div>
