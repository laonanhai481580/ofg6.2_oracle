...
<head>
	...
	function hide(obj){
 		...
 		$.post('${mfgctx}/inspection/patrol/hiddenState.htm?id='+id+"&&type=Y",
 		function(data){
 			  window.location.reload(href='${mfgctx}/inspection/patrol/list-hid.htm');
			  alert("修改成功");
 		});
	}
	</script>
	...
	<div class="ui-layout-center">
			<div class="opt-body">
				<aa:zone name="main">
					...
					<button  class='btn' onclick="iMatrix.export_Data('${mfgctx}/inspection/patrol/patrol-exports-hide.htm');" type="button"><span><span><b class="btn-icons btn-icons-export"></b>导出</span></span></button>
					</security:authorize>
					...
					<div id="opt-content">
						<form id="contentForm" name="contentForm" method="post" action="">
							<grid:jqGrid gridId="dynamicInspection"  url="${mfgctx}/inspection/patrol/list-hide-datas.htm" code="MFG_PATROL_REPORT" pageName="page"></grid:jqGrid>
						</form>
					</div>
				</aa:zone>
			</div>
