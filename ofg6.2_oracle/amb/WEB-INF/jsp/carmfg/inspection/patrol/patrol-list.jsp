...
<head>
	...
	function hide(obj){
 		...
 		$.post('${mfgctx}/inspection/patrol/hiddenState.htm?id='+id+"&&type=N",
 		function(data){
 			  window.location.reload(href='${mfgctx}/inspection/patrol/patrol-list.htm');
			  alert("修改成功");
 		});
	}
	</script>
	...
	<div class="ui-layout-center">
			<div class="opt-body">
				<aa:zone name="main">
					...
					<security:authorize ifAnyGranted="mfg_patrol_exports">
					<button  class='btn' onclick="iMatrix.export_Data('${mfgctx}/inspection/patrol/patrol-exports.htm');" type="button"><span><span><b class="btn-icons btn-icons-export"></b>导出</span></span></button>
					</security:authorize>
					<security:authorize ifAnyGranted="mfg_patrol_hide">
					...
					<div id="opt-content">
						<form id="contentForm" name="contentForm" method="post" action="">
							<grid:jqGrid gridId="dynamicInspection"  url="${mfgctx}/inspection/patrol/patrol-list-datas.htm" code="MFG_PATROL_REPORT" pageName="page"></grid:jqGrid>
						</form>
					</div>
				</aa:zone>
			</div>
