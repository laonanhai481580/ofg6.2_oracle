	...
	<div class="ui-layout-center">
			<div class="opt-body">
				<aa:zone name="main">
					...
					<security:authorize ifAnyGranted="mfg_rechecck_patrol_export">
					<button  class='btn' onclick="iMatrix.export_Data('${mfgctx}/inspection/patrol/recheck-export.htm');" type="button"><span><span><b class="btn-icons btn-icons-export"></b>导出</span></span></button>
					</security:authorize>
					<span id="message"></span>
					</div>
					<div id="opt-content">
						<form id="contentForm" name="contentForm" method="post" action="">
							<grid:jqGrid gridId="dynamicInspection"  url="${mfgctx}/inspection/patrol/recheck-list-datas.htm" code="MFG_PATROL_REPORT" pageName="page"></grid:jqGrid>
						</form>
					</div>
				</aa:zone>
			</div>
