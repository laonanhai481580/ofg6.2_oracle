...
// 			resolutionString();
		...
		<%
			...
			for(MfgPatrolDetail item:checkItems){
...
<body onclick="$('#sysTableDiv').hide(); $('#styleList').hide();">
	...
	<div class="fixed_div" id="left-tabs" style="width:20%;height: 100%;">
	 ...
	 <div class="virtual_body" style="width:80%;float: right;">
		<input type="hidden" id="id" name="id" value="${id}"/>
	    <div class="left-right,main" style="height:100%;text-align: center;height:<%=checkItemsHeight*30+200%>px;">
