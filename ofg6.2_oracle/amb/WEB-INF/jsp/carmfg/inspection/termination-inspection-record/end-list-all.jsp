...
<head>
	...
	function hide(obj){
 		...
 		function(data){
 			  window.location.reload(href='${mfgctx}/inspection/made-inspection/end-list-all.htm');
			  alert("修改成功");
 		});
	}
	...
	<div class="ui-layout-center">
			<div class="opt-body">
				<aa:zone name="main">
					...
					<button  class='btn' onclick="iMatrix.export_Data('${mfgctx}/inspection/termination-inspection-record/export-end-list-all.htm');" type="button"><span><span><b class="btn-icons btn-icons-export"></b>导出台账</span></span></button>
					</security:authorize>
