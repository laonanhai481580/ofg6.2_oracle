...
<head>
	...
	function hide(obj){
 		...
 		function(data){
 			  window.location.reload(href='${mfgctx}/inspection/made-inspection/patrol-all-list.htm');
			  alert("修改成功");
 		});
	}
	...
	<div class="ui-layout-center">
			<div class="opt-body">
				<aa:zone name="main">
					...
					<security:authorize ifAnyGranted="termination-inspection-patrol-record-delete">
					...
					<security:authorize ifAnyGranted="termination-inspection-patrol-record-export">
					<button  class='btn' onclick="iMatrix.export_Data('${mfgctx}/inspection/termination-inspection-record/export-patrol-list-all.htm');" type="button"><span><span><b class="btn-icons btn-icons-export"></b>导出台账</span></span></button>
					</security:authorize>
					...
					<div id="opt-content">
						<form id="contentForm" name="contentForm" method="post" action="">
							<grid:jqGrid gridId="dynamicInspection"  url="${mfgctx}/inspection/termination-inspection-record/patrol-list-all-datas.htm" code="MFG_PATROL_INSPECTION_REPORT" pageName="page"></grid:jqGrid>
						</form>
					</div>
				</aa:zone>
			</div>
