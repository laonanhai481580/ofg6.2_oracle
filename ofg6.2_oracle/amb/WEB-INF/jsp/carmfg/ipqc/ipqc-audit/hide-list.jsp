		...
		function importDatas(){
 		...
 		var params = {};
 	 	function hide(obj){
 	 		...
 	 		var url="${mfgctx}/ipqc/ipqc-audit/hiddenState.htm?id="+id+"&&type=Y";
...
<body onclick="$('#sysTableDiv').hide(); $('#styleList').hide();" >
	<script type="text/javascript">
		...
		var thirdMenu="_IPQC_AUDIT_HIDE";
	</script>
		...
		<div class="opt-body">
			...
			<aa:zone name="main">
				<div class="opt-btn">
					...
					<security:authorize ifAnyGranted="MFG_IPQC_AUDIT_EXPORT_HIDE">
					    <button  class='btn' onclick="iMatrix.export_Data('${mfgctx}/ipqc/ipqc-audit/export-hide.htm');" type="button"><span><span><b class="btn-icons btn-icons-export"></b>导出</span></span></button>		
					</security:authorize> 
				...
				<div id="opt-content" >
					<form id="contentForm" name="contentForm" method="post"  action="">
						<grid:jqGrid gridId="list" url="${mfgctx}/ipqc/ipqc-audit/hide-list-datas.htm" submitForm="defaultForm" code="MFG_IPQC_AUDIT" ></grid:jqGrid>
					</form>
				</div>
			</aa:zone>
		</div>
