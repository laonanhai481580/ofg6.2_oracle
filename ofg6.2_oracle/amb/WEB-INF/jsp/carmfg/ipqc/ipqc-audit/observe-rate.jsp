...
<head>
	...
	function showDetail(name,xvalue){
		...
		$.colorbox({href:'${mfgctx}/ipqc/ipqc-audit/observe-rate-show-detail.htm?searchParams='+str,iframe:true,
		...
		<div id="search" style="display:block;"  >
			<table class="form-table-outside-border" style="width:100%;display:block;">
				<tr>
					...
					<td style="text-align: right;width:60px;">工厂</td>
					<td style="width:150px;">
					...
					<td style="text-align: right;width:60px;">工序</td>
					<td style="width:150px;">
