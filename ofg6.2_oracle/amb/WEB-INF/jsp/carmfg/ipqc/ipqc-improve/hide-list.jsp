...
<script type="text/javascript" src="${resourcesCtx}/js/search.js"></script>
	<c:set var="actionBaseCtx" value="${mfgctx}/ipqc/ipqc-improve" />
	<script type="text/javascript">
				var buttonSign="";
		function addForm(){
...
<body onclick="$('#sysTableDiv').hide(); $('#styleList').hide();" >
	<script type="text/javascript">
		...
		var thirdMenu="_IPQC_IMPROVE_HIDE";
	</script>
		...
		<div class="opt-body">
			...
			<aa:zone name="main">
				<div class="opt-btn">
					...
					<security:authorize ifAnyGranted="MFG_IPQC_IMPROVE_EXPORT_HIDE">
					...
					<security:authorize ifAnyGranted="MFG_IPQC_IMPROVE_HIDE">
				...
				<div id="opt-content" >
					...
					<grid:jqGrid gridId="list" url="${actionBaseCtx}/hide-list-datas.htm"
						submitForm="defaultForm" code="MFG_IPQC_AUDIT_IMPROVE"></grid:jqGrid>
					</form>
				</div>
			</aa:zone>
		</div>
