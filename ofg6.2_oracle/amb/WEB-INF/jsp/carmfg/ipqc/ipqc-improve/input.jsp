...
<script type="text/javascript">
	...
	function submitFormBefore(){
		var departmentManLogin=$("#departmentManLogin").val();
		if(departmentManLogin!=null&&departmentManLogin!=""){
			$("#isDuice").val("是");
		}
		submitForm();
	}
...
<body onload="getContentHeight();">
	<script type="text/javascript">
		...
		var thirdMenu="_IPQC_IMPROVE_INPUT";
	</script>
		...
		<div class="opt-body">
			<aa:zone name="main">
				<div class="opt-btn">
					...
					<s:else>
						<security:authorize ifAnyGranted="MFG_IPQC_IMPROVE_SAVE">
						  <button class='btn' type="button" onclick="saveForm();"><span><span><b class="btn-icons btn-icons-save"></b><s:text name='保存'/></span></span></button>  
							<button class='btn' type="button" onclick="submitFormBefore();">
