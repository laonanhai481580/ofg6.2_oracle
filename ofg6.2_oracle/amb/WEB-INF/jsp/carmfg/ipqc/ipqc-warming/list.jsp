...
<head>
	...
	<script type="text/javascript">
		...
		function $beforeEditRow(rowId,iRow,iCol,e){
			var isRight = false;
			<security:authorize ifAnyGranted="MFG_IPQC_WARMING_SAVE">
				isRight =  true;
			</security:authorize>
			return isRight;
		}
		...
		<div class="opt-body">
			...
			<aa:zone name="main">
				<div class="opt-btn">
					...
					<security:authorize ifAnyGranted="MFG_IPQC_WARMING_DELETE">
					...
					<security:authorize ifAnyGranted="MFG_IPQC_WARMING_EXPORT">
						<button class="btn" onclick="iMatrix.export_Data('${mfgctx}/ipqc/ipqc-warming/export.htm');"><span><span><b class="btn-icons btn-icons-export"></b>导出</span></span></button>
					</security:authorize>
				...
				<div id="opt-content" >
					<form id="contentForm" name="contentForm" method="post"  action="">
						<grid:jqGrid gridId="list" url="${mfgctx}/ipqc/ipqc-warming/list-datas.htm" submitForm="defaultForm" code="MFG_IPQC_AUDIT_WARMING" ></grid:jqGrid>
					</form>
				</div>
			</aa:zone>
		</div>
