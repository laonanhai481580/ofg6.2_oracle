			...
			<aa:zone name="main">
				...
				<div id="opt-content">
					<form id="contentForm" method="post" action="" >
						<grid:jqGrid gridId="ortItemList" url="${epmctx}/base-info/ort-item/list-select-datas.htm?customerNo=${customerNo}&productNo=${productNo}&sampleType=${sampleType}" code="EPM_ORT_ITEM"></grid:jqGrid>		
					</form>
				</div>
			</aa:zone>
		</div>
