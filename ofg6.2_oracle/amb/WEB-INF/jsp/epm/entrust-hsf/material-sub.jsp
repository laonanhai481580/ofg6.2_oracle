...
<table class="form-table-border-left"
	...
	<tbody>
		<tr>
			...
			<td style="width: 120px; text-align: center; border-top: 0px;">样品物料编码</td>
			<td style="width: 100px; text-align: center; border-top: 0px;">样品类别</td>
			...
			<td style="width: 100px; text-align: center; border-top: 0px;">客户</td>
			<td style="width: 100px; text-align: center; border-top: 0px;">样品阶段</td>
			<td style="width: 100px; text-align: center; border-top: 0px;">风险等级</td>
			...
			<td style="width: 100px; text-align: center; border-top: 0px;">结束时间</td>
			<!-- <td style="width: 100px; text-align: center; border-top: 0px;">测试前结果</td> -->
			<td style="width: 100px; text-align: center; border-top: 0px;">测试点数</td>
			<td style="width: 100px; text-align: center; border-top: 0px;">NG点数</td>
			<td style="width: 100px; text-align: center; border-top: 0px;">测试结果</td>
		...
		<s:iterator value="_entrustHsfSublists" id="item" var="item">
			<tr class="entrustHsfSublists" zbtr1=true lazy=false>
				...
				<td style="text-align: center;"><input stage="one"
					style="width: 90%;" name="sampleMaterialCode" value="${sampleMaterialCode }" /></td>
				<td style="text-align: center;"><s:select list="sampleSorts"
						style="width:100px;" listKey="value" listValue="value"
						name="sampleSort" id="sampleSort" emptyOption="true" onchange=""
						stage="one" theme="simple">
					</s:select></td>
				<td style="text-align: center;"><input stage="one"
				...
				<td style="text-align: center;"><input stage="one"
					style="width: 100%;" name="sampleStage" value="${sampleStage }" /></td>
				<td style="text-align: center;"><s:select list="riskGrades"
						style="width:100px;" listKey="value" listValue="value"
						name="riskGrade" id="riskGrade" emptyOption="true" onchange=""
						stage="one" theme="simple">
					</s:select></td>
				<td>
...
<%-- 				<td style="text-align: center;"><input stage="two"
				...
				<td style="text-align: center;"><input stage="three"
					style="width: 100%;" name="testPoint" value="${testPoint }" /></td>
				<td style="text-align: center;"><input stage="three"
					style="width: 100%;" name="ngPoint" value="${ngPoint }" /></td>					
				...
				<td><input type="hidden" value="${exceptionNo}"
					name="exceptionNo"
