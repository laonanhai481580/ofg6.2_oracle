...
<%-- 				<s:select list="sampleTypes" listKey="value" listValue="value" name="sampleType" id="sampleType" emptyOption="true" onchange="" theme="simple"></s:select>  --%>
		...
		<tr>
			...
			<td colspan="3">
			<s:radio cssStyle="margin-left:8px;" name="category" id="category" value="#request.category" theme="simple" onclick="showInput(this)" list="categorys" listKey="value" listValue="name"/>
			</td>
		...
		<tr>
			...
			<td colspan="3"></td>
			<td ><input type="hidden" id="epmState" name="epmState" value="${epmState }"/></td>
		</tr>
	</table>