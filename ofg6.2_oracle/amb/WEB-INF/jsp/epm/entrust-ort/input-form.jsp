...
<%-- 				<s:select list="productNos"	listKey="value" listValue="value" name="productNo" id="productNo" emptyOption="true" onchange="" theme="simple"></s:select>  --%>
			...
			<td style="text-align:center;">客户机种</td>
			<td ><input id="modelName" name="modelName" value="${modelName}"/></td>			
		</tr>
		<tr>
		...
		<tr>
			...
			<td ><input id="rejectedMaterialNo" name="rejectedMaterialNo" value="${rejectedMaterialNo}" /></td>
 			<td style="text-align:center;">客户需要</td>
			<td>
				<s:select list="customerNeeds" style="width:100px;"
					listKey="value" 
					listValue="value" 
					name="customerNeed" 
					id="customerNeed"
...
<%-- 	        <input name="category" onchange="chekced()" class="checkboxLabel" value="${category}" /> --%>
			...
			<div style="overflow-x:auto;overflow-y:hidden;">
				...
				<tbody>
					<tr >	
						...
						<td  style="width:150px;text-align:center;border-top:0px;">二维码</td>
						...
						<td style="width:100px;text-align:center;border-top:0px;">测试工站</td>
						<td style="width:100px;text-align:center;border-top:0px;">测试设备</td>
						<td style="width:100px;text-align:center;border-top:0px;">测试项目</td>
						<td style="width:100px;text-align:center;border-top:0px;">规格下限</td>
						<td style="width:100px;text-align:center;border-top:0px;">规格上限</td>
						<td style="width:100px;text-align:center;border-top:0px;">测试值</td>
						<td style="width:100px;text-align:center;border-top:0px;">是否上传</td>
					...
					<s:iterator value="_entrustOrtSublists" id="item" var="item">
						<tr class="entrustOrtSublists" zbtr1=true>
							...
							<td style="text-align: center;"><input stage="one" style="width:80%;" name="quickResponse" value="${quickResponse }"/>
							</td>
							<td style="text-align: center;">
							...
							<td style="text-align: center;"><textarea stage="one" style="width:95%;" name="criterionG"  >${criterionG }</textarea></td>
							...
							<td style="text-align: center;">
								...
								<td style="text-align: center;"><input stage="one" style="width:80%;" name="testStation"  value="${testStation }"/></td>
								<td style="text-align: center;"><textarea stage="one" style="width:80%;" name="equipmentNumber" >${equipmentNumber }</textarea></td>
								<td style="text-align: center;"><textarea stage="one" style="width:80%;" name="testItem" >${testItem }</textarea></td>
								<td style="text-align: center;"><input stage="one" style="width:80%;" name="lower" value="${lower }"/></td>
								<td style="text-align: center;"><input stage="one" style="width:80%;" name="upper" value="${upper }"/></td>
								<td style="text-align: center;"><input stage="one" style="width:80%;"    name="testValue" value="${testValue }" onchange="setweigh(this)" class="{number:true,messages:{number:'请输入有效数字!'}}" /></td>
								<td style="text-align: center;"><input stage="one" style="width:80%;" name="upload"  value="${upload }"/></td>
							...
							<td>
								<input  value="${exceptionNo}" name="exceptionNo" style="width: 90%;border:none;text-align: center;background: none;" type="hidden"></input>
								<input name="exceptionId" id="exceptionId" value="${exceptionId}" type="hidden" />
								<a title="查看检验单详情" href="javascript:void(0);exceptionInput('${exceptionId}')">${exceptionNo}</a>
		...
		<tr>
			...
			<td style="text-align:center;">上传报告人</td>
			<td colspan="3">
				<input id="reportUpda" name="reportUpda" hiddenInputId="reportUpdaLoing" style="float: left;" isUser="true" value="${reportUpda}"/>
				<input type="hidden" id="reportUpdaLoing" name="reportUpdaLoing" value="${reportUpdaLoing }"/>
			</td>
