...
function exceptionInput(itemId,itemNo){
	if(itemId&&itemId!=""){
		if(itemNo.indexOf("REL")>-1){
			window.open('${epmctx}/entrust-ort/input.htm?id='+itemId);
		}else if(itemNo.indexOf("HSF")>-1){
			window.open('${epmctx}/entrust-hsf/input.htm?id='+itemId);
		}							
	};		
}	
