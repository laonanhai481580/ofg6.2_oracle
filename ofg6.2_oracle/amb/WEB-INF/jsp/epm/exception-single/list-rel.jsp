...
<c:set var="actionBaseCtx" value="${epmctx}/exception-single" />
<script type="text/javascript">
	...
	function $oneditfunc(rowid) {
	 ...
	 function hide(obj){
	 		...
	 		$.post('${epmctx}/exception-single/hide.htm?id='+id+"&&state=N",
	 		function(result){
	 			if(result.error){
...
<body onclick="$('#sysTableDiv').hide(); $('#styleList').hide();">
	<script type="text/javascript">
		...
		var thirdMenu = "exceptionSingleList-REL";
	</script>
	...
	<div class="ui-layout-center">
		<div class="opt-body">
			<aa:zone name="main">
				<div class="opt-btn">
					<security:authorize ifAnyGranted="epm_exceptionSingle_delete">
					...
					<security:authorize ifAnyGranted="exceptionSingle_export">
						<button class='btn' onclick="iMatrix.export_Data('${actionBaseCtx}/export.htm?type=REL&state=N');"
							type="button">
				...
				<div id="opt-content">
					<form id="contentForm" method="post" action="">
						<grid:jqGrid gridId="list" url="${actionBaseCtx}/list-type.htm?type=REL&state=N"
							code="EPM_EXCEPTION_SINGLE" pageName="page"></grid:jqGrid>
					</form>
				</div>	
			</aa:zone> 
		</div>
