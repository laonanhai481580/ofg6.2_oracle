...
<script type="text/javascript">
	...
	function $oneditfunc(rowid) {
	 ...
	 function hide(obj){
	 		...
	 		$.post('${epmctx}/exception-single/hide.htm?id='+id+"&&state=Y",
	 		function(result){
	 			if(result.error){
...
<body onclick="$('#sysTableDiv').hide(); $('#styleList').hide();">
	<script type="text/javascript">
		...
		var thirdMenu = "exceptionSingleList-y";
	</script>
			...
			<aa:zone name="main">
				<div class="opt-btn">
					...
					<security:authorize ifAnyGranted="exceptionSingle_export">
						<button class='btn' onclick="iMatrix.export_Data('${actionBaseCtx}/export.htm?state=Y');"
							type="button">
				...
				<div id="opt-content">
					<form id="contentForm" method="post" action="">
						<grid:jqGrid gridId="list" url="${actionBaseCtx}/list-type.htm?state=Y"
