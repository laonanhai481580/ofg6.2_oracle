...
<body onclick="$('#sysTableDiv').hide(); $('#styleList').hide();">
	<script type="text/javascript">
		...
		var thirdMenu = "exceptionSingleList";
	</script>
			...
			<aa:zone name="main">
				<div class="opt-btn">
					...
					<security:authorize ifAnyGranted="exceptionSingle_export">
						<button class='btn' onclick="iMatrix.export_Data('${actionBaseCtx}/export.htm?type=HSF&state=N');"
							type="button">
				...
				<div id="opt-content">
					<form id="contentForm" method="post" action="">
						<grid:jqGrid gridId="list" url="${actionBaseCtx}/list-type.htm?type=HSF&state=N"
