...
<body onclick="$('#sysTableDiv').hide(); $('#styleList').hide();" >
	<script type="text/javascript">
		...
		var thirdMenu="averageList_qualified";
	</script>
		...
		<div class="opt-body">
			...
			<aa:zone name="main">
				...
				<security:authorize ifAnyGranted="averageMaterial_delete1">
					...
					<button id="searchBtn" class='btn' onclick="iMatrix.showSearchDIV(this);"><span><span><b class="btn-icons btn-icons-search"></b></b><s:text name="portal.query"/></span></span></button>
					<security:authorize ifAnyGranted="averageMaterial_export">
						<button class="btn" onclick="iMatrix.export_Data('${gpctx}/averageMaterial/export.htm?type=3');"><span><span><b class="btn-icons btn-icons-export"></b><s:text name="portal.导出"/></span></span></button>
					</security:authorize>
				...
				<div id="opt-content" >
					<form id="contentForm" name="contentForm" method="post"  action="">
						<grid:jqGrid gridId="list" url="${gpctx}/averageMaterial/list-datas.htm?type=3" submitForm="defaultForm" code="GP_AVERAGE_MATERIAL_OVERDUE" ></grid:jqGrid>
					</form>
				</div>
			</aa:zone>
		</div>
