			...
			<aa:zone name="main">
				<div class="opt-btn">
					...
					<security:authorize ifAnyGranted="averageMaterial_import">
						<button class='btn' onclick="importDatas();" type="button"><span><span><b class="btn-icons btn-icons-import"></b><s:text name="portal.导入"/></span></span></button>
						<button class="btn" onclick="downloadTemplate();"><span><span><b class="btn-icons btn-icons-download"></b></b><s:text name="portal.下载导入模版"/></span></span></button>
					</security:authorize>	
					<security:authorize ifAnyGranted="averageMaterial_export">
						<button class="btn" onclick="iMatrix.export_Data('${gpctx}/averageMaterial/export.htm?type=0');"><span><span><b class="btn-icons btn-icons-export"></b><s:text name="portal.导出"/></span></span></button>
					</security:authorize>
