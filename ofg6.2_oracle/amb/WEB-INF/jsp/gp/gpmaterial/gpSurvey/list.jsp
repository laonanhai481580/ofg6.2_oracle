			...
			<aa:zone name="main">
				<div class="opt-btn">
					...
					<security:authorize ifAnyGranted="gpSurvey_export">
						<button class="btn" onclick="iMatrix.export_Data('${gpctx}/gpmaterial/gpSurvey/export.htm');"><span><span><b class="btn-icons btn-icons-export"></b><s:text name="portal.导出"/></span></span></button>
					</security:authorize>
					<security:authorize ifAnyGranted="gpSurvey_import">
						...
						<button class="btn" onclick="downloadTemplate();"><span><span><b class="btn-icons btn-icons-download"></b><s:text name="下载导入模版"/></span></span></button>
					</security:authorize>	
