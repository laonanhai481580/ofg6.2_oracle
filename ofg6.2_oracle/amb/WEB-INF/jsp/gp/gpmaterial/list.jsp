	...
	<div class="ui-layout-center">
		<div class="opt-body">
			<aa:zone name="main">
				...
				<security:authorize ifAnyGranted="gp-find-supplier">
					<button href="#" class="btn" onclick="findSupplierMaterial()"><span><span><s:text name="gp.form.重新关联"/></span></span></button>
				</security:authorize> 
				<security:authorize ifAnyGranted="gp-gpmaterial-export">
				    <button  class='btn' onclick="iMatrix.export_Data('${actionBaseCtx}/export.htm');" type="button"><span><span><b class="btn-icons btn-icons-export"></b><s:text name="portal.导出"/></span></span></button>		
				</security:authorize> 
