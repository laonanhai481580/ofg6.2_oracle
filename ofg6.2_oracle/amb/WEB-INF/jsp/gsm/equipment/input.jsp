...
<head>
	...
	$(document).ready(function(){
		...
		$('#nextProofTime').datepicker({changeMonth:true,changeYear:true});
...
<%-- 								  emptyOption="true"></s:select> --%>
						...
						<tr>
							<td>提前预警天数</td>
							<td><input id="warnDates" name="warnDates" value="${warnDates}"/></td>
							<td>工厂</td>
							<td>
						...
						<tr>
							...
							<td>盘点时间</td>
							<td><input id="stocktakingTime" name="stocktakingTime" readonly="readonly" value='<s:date name="stocktakingTime" format="yyyy-MM-dd HH:mm"/>'/></td>
							<td>下次校验时间</td>
							<td><input id="nextProofTime" name="nextProofTime" readonly="readonly" value='<s:date name="nextProofTime" format="yyyy-MM-dd "/>'/></td>
...
<!-- 							<td>所属事业部</td> -->
<!-- 							<td> -->
<%-- 							<input id="processSection" name="processSection" value="${processSection}"/> --%>
<!-- 							</td> -->
							<td>使用部门</td>
							...
							<td>盘点计划人</td>
							<td><input id="stockPlanPerson" name="stockPlanPerson" readonly="readonly" value="${stockPlanPerson}"/></td>
							<td>计划盘点时间</td>
							<td><input id="stockPlanTime" name="stockPlanTime" readonly="readonly" value='<s:date name="stockPlanTime" format="yyyy-MM-dd "/>'/></td>
						</tr>
						<tr>
							<td>盘点人</td>
							<td><input id="stockActualPerson" name="stockActualPerson" readonly="readonly" value="${stockActualPerson}"/></td>
							<td>盘点时间</td>
							<td><input id="stockActualTime" name="stockActualTime" readonly="readonly" value='<s:date name="stockActualTime" format="yyyy-MM-dd "/>'/></td>
						</tr>
							...
							<td colspan="6">
								<table class="form-table-border-left" style="width:100%;margin: auto;">
									...
									<tr>
										...
										<td>
											<a title="查看检验单详情" href="javascript:void(0);exceptionInput('${innerReportId}','${innerReportNo}')">${innerReportNo}</a>
										</td>
										<td>
											${checkResult}
										</td>
