...
<head>
	...
	<c:set var="actionBaseCtx" value="${gsmctx}/equipment"/>
			...
			<aa:zone name="main">
				...
				<div id="opt-content">
					<form id="contentForm" method="post" action="" >
						<grid:jqGrid gridId="dynamicEqm" url="${gsmctx}/equipment/list-datas-select-all.htm" code="GSM_EQUIPMENT" pageName="page" ></grid:jqGrid>
					</form>
				</div>
			</aa:zone>
		</div>
