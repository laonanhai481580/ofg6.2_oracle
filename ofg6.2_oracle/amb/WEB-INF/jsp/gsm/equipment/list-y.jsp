...
//格式化编号
	...
	*/
	...
	function hideState(obj){
		...
		$.post('${gsmctx}/equipment/hideState.htm?id='+id+"&&type=Y",
		function(data){
	...
	function selectQualityType(obj){
		window.location.href = encodeURI('${gsmctx}/equipment/list-y.htm?processSection='+ obj.value);
	}
...
<!-- 					<table>
					...
					<form id="contentForm" method="post" action="">
						<grid:jqGrid gridId="dynamicMeasurementEquipment" url="${gsmctx}/equipment/list-state.htm?type=Y" code="GSM_EQUIPMENT" pageName="page" dynamicColumn="${dynamicColumn}"></grid:jqGrid>
					</form>
				</div>
			</aa:zone>
		</div>
