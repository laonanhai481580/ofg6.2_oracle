...
<script type="text/javascript">
		...
		function selectQualityType(obj){
			window.location.href = encodeURI('${gsmctx}/inspectionplan/inner-report/list.htm?processSection='+ obj.value);
		}
	...
	<div class="ui-layout-center">
		<div class="opt-body">
			...
			<div class="opt-btn">
				...
				<security:authorize ifAnyGranted="GSM_INNER_CHECK_REPORT_DELETE">
				...
				<security:authorize ifAnyGranted="GSM_INNER_CHECK_REPORT_EXPORT">
					<button class='btn'
			...
			<div id="opt-content">
				<form id="contentForm" name="contentForm" method="post" action="">
					<grid:jqGrid gridId="list" url="${actionBaseCtx}/list-state.htm?type=N"
						submitForm="defaultForm" code="GSM_INNER_CHECK_REPORT"></grid:jqGrid>
				</form>
			</div>
		</div>
	</div>
