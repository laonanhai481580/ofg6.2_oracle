...
%> 
	<table style="width:100%;margin: auto;" class="form-table-border-left" id="default-table">
		...
		<tr>
			...
			<td style="width:160px;text-align:center;">保管人</td>
			<td style="width:200px;">
				<input type="text" id="preserver" isUser="true" hiddenInputId="preserverLogin" style="float: left;"  name="preserver" value="${preserver}" />
				...
				<tbody>
					<s:iterator value="_newEquipmentSublists" id="item" var="item">
						<tr class="newEquipmentSublists">
							...
							<td style="text-align: center;"><input type="text" stage="one" name="preservers" value="${preservers}" /></td>
