...
%> 
	<table style="width:100%;margin: auto;" class="form-table-border-left" id="default-table">
		...
		<tr>
			<td colspan="6" style="text-align:center;background-color:#ADD8E6;">实验室验证:</td>
		</tr>
		<tr>
			<td colspan="6"><textarea id="laboratorycheck" name="laboratorycheck" >${laboratorycheck }</textarea></td>
		</tr>
		<tr>
			<td style="text-align:center;background-color:#ADD8E6;">确认人/日期</td>
			...
			<td style="text-align:center;background-color:#ADD8E6;">审核人/日期</td>
		...
		<tr colspan="6" style="background-color:#90EE90;">
		...
		<tr >
			<td style="text-align:center;background-color:#90EE90;">核准人</td>
		...
		<tr>
			...
			<td style="text-align:center;background-color:#ADD8E6;">确认日期</td>
		...
		<tr> 
			<td colspan="6" style="text-align:center;background-color:#90EE90;">报废仓/行政确认</td>
		</tr>
		<tr>
			<td colspan="6"><textarea id="AdminDept" name="AdminDept" >${AdminDept }</textarea></td>
		</tr>
		<tr>
			<td style="text-align:center;background-color:#90EE90;">确认人</td>
			...
			<td style="text-align:center;background-color:#90EE90;">确认日期</td>
		...
		<tr>
			<td colspan="6" style="text-align:center;background-color:#ADD8E6;">实验室确认:</td>
		</tr>
		<tr>
