...
<%@ page import="com.ambition.gsm.entity.ScrapList" %>
	...
	<div class="ui-layout-center">
		<div class="opt-body">
			...
			<s:if test="taskId>0">
					...
					<s:else>
						<security:authorize ifAnyGranted="GSM_SCRAP_SAVE">
						...
						<security:authorize ifAnyGranted="GSM_SCRAP_SUBMIT">
