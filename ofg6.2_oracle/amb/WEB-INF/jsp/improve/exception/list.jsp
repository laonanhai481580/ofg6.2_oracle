...
<body onclick="$('#sysTableDiv').hide(); $('#styleList').hide();">
	<script type="text/javascript">
		...
		var thirdMenu="exception_report_list";
	</script>
	...
	<div class="ui-layout-center">
		<div class="opt-body">
			...
			<div class="opt-btn">
				...
				<security:authorize ifAnyGranted="IMP_EXCEPTION_REPORT_DELETE">
				...
				<security:authorize ifAnyGranted="IMP_EXCEPTION_REPORT_EXPORT">
					<button class='btn'
			...
			<div id="opt-content">
				<form id="contentForm" name="contentForm" method="post" action="">
					<grid:jqGrid gridId="list" url="${actionBaseCtx}/list-datas.htm"
						submitForm="defaultForm" code="IMP_QUALITY_EXCEPTION_REPORT"></grid:jqGrid>
				</form>
			</div>
		</div>
	</div>
