...
<body onclick="$('#sysTableDiv').hide(); $('#styleList').hide();">
	<script type="text/javascript">
		...
		var thirdMenu="exception_share_list";
	</script>
	...
	<div class="ui-layout-center">
		<div class="opt-body">
			...
			<div class="opt-btn">
				<security:authorize ifAnyGranted="IMP_EXCEPTION_REPORT_CANCLE">
				...
				<security:authorize ifAnyGranted="IMP_EXCEPTION_REPORT_SHARE_EXPORT">
					<button class='btn'
			...
			<div id="opt-content">
				<form id="contentForm" name="contentForm" method="post" action="">
					<grid:jqGrid gridId="list" url="${actionBaseCtx}/share-list-datas.htm"
						submitForm="defaultForm" code="IMP_QUALITY_EXCEPTION_SHARE"></grid:jqGrid>
				</form>
			</div>
		</div>
	</div>
