		...
		<div class="opt-body">
			<aa:zone name="main">
				<div class="opt-btn">
					...
					<security:authorize ifAnyGranted="IMP_8DREPORT_EXPORT_HIDE">
					...
					<security:authorize ifAnyGranted="IMP_8DREPORT_REPORT_HIDE">
				...
				<div id="opt-content">
					<form id="contentForm" method="post" action="" >
						<grid:jqGrid gridId="dynamicComplain" url="${actionBaseCtx}/hide-list-datas.htm" code="IMP_8D_REPORT" pageName="page" ></grid:jqGrid>
					</form>
				</div>
			</aa:zone>
		</div>
