		...
		<tr>
			...
			<td style="width:200px;">
				<select name="problemSource" id="problemSource" >
					<option value=""></option>
				    <option ty="1" value="客户端IQC" <s:if test="%{problemSource.indexOf('客户端IQC')>=0}">selected="selected"</s:if>>客户端IQC</option>
					<option ty="1" value="客户端上线" <s:if test="%{problemSource.indexOf('客户端上线')>=0}">selected="selected"</s:if>>客户端上线</option>
					<option ty="1" value="客户端OQC" <s:if test="%{problemSource.indexOf('客户端OQC')>=0}">selected="selected"</s:if>>客户端OQC</option>
					<option ty="1" value="客户端市场退机" <s:if test="%{problemSource.indexOf('客户端市场退机')>=0}">selected="selected"</s:if>>客户端市场退机</option>
					<option ty="1" value="客户端RA实验" <s:if test="%{problemSource.indexOf('客户端RA实验')>=0}">selected="selected"</s:if>>客户端RA实验</option>
					
					<option ty="2" value="厂内设计评审" <s:if test="%{problemSource.indexOf('厂内设计评审')>=0}">selected="selected"</s:if>>厂内设计评审</option>
					<option ty="2" value="厂内IQC异常" <s:if test="%{problemSource.indexOf('厂内IQC异常')>=0}">selected="selected"</s:if>>厂内IQC异常</option>					
					<option ty="2" value="厂内制程异常" <s:if test="%{problemSource.indexOf('厂内制程异常')>=0}">selected="selected"</s:if>>厂内制程异常</option>
					<option ty="2" value="厂内RA验证异常" <s:if test="%{problemSource.indexOf('厂内RA验证异常')>=0}">selected="selected"</s:if>>厂内RA验证异常</option>
				</select>
			</td>			
...
<!-- 			    <script id="problemDescrible" type="text/plain" style="width:1024px;height:500px;"></script>   -->
				<textarea rows="5" type="text/plain" style="width:100%"  id="problemDescrible" name="problemDescrible"  >${problemDescrible}</textarea>
			</td>
		</tr>
		<tr>
			<td style="width:160px;text-align:center;">附件上传</td>
			<td style="width:200px;" colspan="5">
				<input type="hidden"  isFile="true" id="attachmentD1" name="attachmentD1" value="${attachmentD1}"/>
			</td>
		</tr>	
		<tr style="background-color: CornflowerBlue;color: white;font-weight: bold;">
...
<%-- 			<td style="width:160px;text-align:center;">部门</td>
		...
		<tr>
			...
			<td style="width:200px;">
				<input  name="clientStore" id="clientStore" value="${clientStore}" ></input>
			</td>
		...
		<tr>
			<td style="width:200px;" colspan="6">
				<textarea rows="5"   id="remarkD4" name="remarkD4"  >${remarkD4}</textarea>
			</td>
		</tr>
		<tr>
			<td style="width:160px;text-align:center;">附件上传</td>
		...
		<tr>
			...
			<td style="width:160px;text-align:center;">负责人</td>
			<td style="width:200px;">
				<input type="text" id="dutyManD5" isTemp="true" isUser="true" hiddenInputId="dutyManD5Login" style="float: left;"  name="dutyManD5" value="${dutyManD5}" />
				<input type="hidden" id="dutyManD5Login" name="dutyManD5Login" value="${dutyManD5Login}" />
				<input type="hidden" id="isD5" name="isD5" value="${isD5}" />
			</td>
		</tr>	
		<tr style="background-color: CornflowerBlue;color: white;font-weight: bold;">
		...
		<tr>
			...
			<td style="width:160px;text-align:center;">负责人</td>
			<td style="width:200px;">
				<input type="text" id="dutyManD7" isTemp="true" isUser="true" hiddenInputId="dutyManD7Login" style="float: left;"  name="dutyManD7" value="${dutyManD7}" />
				<input type="hidden" id="dutyManD7Login" name="dutyManD7Login" value="${dutyManD7Login}" />
				<input type="hidden" id="isD7" name="isD7" value="${isD7}" />
			</td>			
		</tr>
		<tr style="background-color: CornflowerBlue;color: white;font-weight: bold;">
