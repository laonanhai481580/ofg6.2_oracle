...
<script type="text/javascript">
		...
		function hide(obj){
	 		...
	 		$.post('${actionBaseCtx}/hiddenState.htm?id='+id+"&&type=Y",
	 		function(data){
	 			  window.location.reload(href='${actionBaseCtx}/list.htm');
				  alert("修改成功");
	 		});
		}
	</script>
	...
	<div class="ui-layout-center">
		<div class="opt-body">
			...
			<div class="opt-btn">
				...
				<security:authorize ifAnyGranted="IMP_8DREPORT_DELETE">
				...
				<security:authorize ifAnyGranted="IMP_8DREPORT_EXPORT">
					<button class='btn'
			...
			<div id="opt-content">
				<form id="contentForm" name="contentForm" method="post" action="">
					<grid:jqGrid gridId="list" url="${actionBaseCtx}/list-datas.htm"
						submitForm="defaultForm" code="IMP_8D_REPORT"></grid:jqGrid>
				</form>
			</div>
		</div>
	</div>
