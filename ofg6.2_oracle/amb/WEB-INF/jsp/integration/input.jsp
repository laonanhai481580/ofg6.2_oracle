		...
		<div class="opt-body">
			...
			<div id="opt-content" style="text-align:center;">
				<table class="form-table-border-left" style="width:100%;margin:2px auto;">
					...
					<security:authorize ifAnyGranted="import-supplier-year-inspect">
					<tr style="height:29px;">
						 <td style="padding-left:4px;">
						 	<span style="font-size:16px;font-weight:bold;">供应商稽核提醒</span>
						 </td>
						 <td>&nbsp;${supplierYearInspect}</td>
						 <td>&nbsp;每天&nbsp;<b><%=DateUtil.formateDateStr(ScheduleJob.getSupplierYearInspectScheduleDate(),"HH:mm")%></b>&nbsp;自动执行</td>
						 <td style="padding-left:6px;">
						 	<button  class='btn' type="button" onclick="updates('${integrationctx}/import-supplier-year-inspect.htm','供应商稽核提醒',150)"><span><span><b class="btn-icons btn-icons-play"></b>立即同步</span></span></button>
						 </td>
					</tr>
					</security:authorize>		
					...
					<security:authorize ifAnyGranted="import-supplier-record">
					<tr style="height:29px;">
						 <td style="padding-left:4px;">
						 	<span style="font-size:16px;font-weight:bold;">供应商名录OR集成</span>
						 </td>
						 <td>&nbsp;${supplierRecord}</td>
						 <td>&nbsp;每天&nbsp;<b><%=DateUtil.formateDateStr(ScheduleJob.getSupplierRecordScheduleDate(),"HH:mm")%></b>&nbsp;自动执行</td>
						 <td style="padding-left:6px;">
						 	<button  class='btn' type="button" onclick="updates('${integrationctx}/import-supplier-record.htm','供应商名录OR集成',150)"><span><span><b class="btn-icons btn-icons-play"></b>立即同步</span></span></button>
						 	<button  class='btn' type="button" onclick="updates('${integrationctx}/import-supplier-improve.htm','供应商改进集成',150)"><span><span><b class="btn-icons btn-icons-play"></b>立即同步</span></span></button>
						 </td>
					</tr>
					</security:authorize>	
				</table>
