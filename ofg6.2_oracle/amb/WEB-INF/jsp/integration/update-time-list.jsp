...
<head>
	...
	<script type="text/javascript">
		...
		function $beforeEditRow(rowId,iRow,iCol,e){
			var isRight = false;
			<security:authorize ifAnyGranted="integration-update-time-save">
				isRight =  true;
			</security:authorize>
			return isRight;
		}
		...
		<div class="opt-body">
			...
			<aa:zone name="main">
				...
				<button id="searchBtn" class='btn' onclick="iMatrix.showSearchDIV(this);"><span><span><b class="btn-icons btn-icons-search"></b>查询</span></span></button>
					...
					<security:authorize ifAnyGranted="integration-update-time-delete">
				...
				<div id="opt-content" >
					<form id="contentForm" name="contentForm" method="post"  action="">
						<grid:jqGrid gridId="list" url="${integrationctx}/update-list-datas.htm" submitForm="defaultForm" code="AMB_UPDATE_TIMESTAMP" ></grid:jqGrid>
					</form>
				</div>
			</aa:zone>
		</div>
