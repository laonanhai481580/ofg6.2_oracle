...
<%-- 							${hisPackingResult} --%>
						...
						<td>
							<input id="hisReportNo" name="hisReportNo" value="${hisReportNo}"/>
<%-- 							${hisReportNo} --%>
						</td>
						<td colspan="2">
...
<%-- 							${ordPackingResult} --%>
						...
						<td>
							<input id="ordReportNo" name="ordReportNo" value="${ordReportNo}"/>
<%-- 							${ordReportNo} --%>
						</td>
						<td colspan="2">
		...
		<tr>
			...
			<td><span style="color:red">*</span>SQE确认人</td>
			<td>
		...
		<tr>
			<td>外观合格数</td>
			<td>
				<input id="appearanceAmount" name="appearanceAmount" value="${appearanceAmount}" class="{required:true,number:true,messages:{required:'必填',number:'必填数字'}}"/>
			</td>
			<td>外观不良数</td>
			<td>
				<input id="appearanceUnAmount" name="appearanceUnAmount" value="${appearanceUnAmount}" class="{required:true,number:true,messages:{required:'必填',number:'必填数字'}}"/>
			</td>
			<td>外观合格率</td>
			<td>
				<input id="appearanceAmountRate" name="appearanceAmountRate" value="${appearanceAmountRate}"  class="{required:true,number:true,messages:{required:'必填',number:'必填数字'}}"/>%
			</td>
		</tr>
		<tr>
			<td>特性合格数</td>
			<td>
				<input id="qualifiedAmount" name="qualifiedAmount" value="${qualifiedAmount}" class="{required:true,number:true,messages:{required:'必填',number:'必填数字'}}"/>
			...
			<td>特性不良数</td>
			<td>
				<input id="unqualifiedAmount" name="unqualifiedAmount" value="${unqualifiedAmount}" class="{required:true,number:true,messages:{required:'必填',number:'必填数字'}}"/>
			...
			<td>特性合格率</td>
			<td>
				<input id="qualifiedRate" name="qualifiedRate" value="${qualifiedRate}" class="{required:true,number:true,messages:{required:'必填',number:'必填数字'}}"/>%
