...
<head>
	...
	function hide(obj){
 		...
 		function(data){
 			  window.location.reload(href='${iqcctx}/inspection-report/recheck-list.htm');
			  alert("修改成功");
 		});
	}
...
<body onclick="$('#sysTableDiv').hide(); $('#styleList').hide();" >
	<script type="text/javascript">
		...
		var thirdMenu="recheckInspectionReport_fpm";
	</script>
		...
		<div class="opt-body">
			<aa:zone name="main">
				<div class="opt-btn" id="btnDiv">
					...
					<security:authorize ifAnyGranted="IQC_INSPECTION-REPORT_RE-CHECK_EXPORT">
						<button class='btn' type="button" onclick="iMatrix.export_Data('${iqcctx}/inspection-report/fpm/export.htm?state=reCheck');"><span><span><b class="btn-icons btn-icons-export"></b>导出</span></span></button>
					</security:authorize>
				...
				<div id="opt-content">
					<form id="contentForm" name="contentForm" method="post"  action="">
						<grid:jqGrid gridId="dynamicInspection"  url="${iqcctx}/inspection-report/fpm/recheck-list-datas.htm" code="IQC_IIAR" pageName="page"></grid:jqGrid>
					</form>
				</div>
			</aa:zone>
		</div>
