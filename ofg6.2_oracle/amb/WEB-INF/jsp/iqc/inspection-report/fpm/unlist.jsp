...
<head>
	...
	function hide(obj){
 		...
 		function(data){
 			  window.location.reload(href='${iqcctx}/inspection-report/fpm/unlist.htm');
			  alert("修改成功");
 		});
	}
	</script>
...
<body onclick="$('#sysTableDiv').hide(); $('#styleList').hide();" >
	<script type="text/javascript">
		...
		var thirdMenu="myUnInspectionReport_fpm";
	</script>
		...
		<div class="opt-body">
			<aa:zone name="main">
				<div class="opt-btn">
					...
					<button class='btn' onclick="iMatrix.export_Data('${iqcctx}/inspection-report/fpm/unexport.htm');" type="button"><span><span><b class="btn-icons btn-icons-export"></b>导出</span></span></button>
					</security:authorize>
				...
				<div id="opt-content">
					<form id="contentForm" name="contentForm" method="post"  action="">
						<grid:jqGrid gridId="dynamicInspection" url="${iqcctx}/inspection-report/fpm/unlist-datas.htm" code="IQC_UNIIR" dynamicColumn="${dynamicColumn}"></grid:jqGrid>
					</form>
					<script type="text/javascript">
