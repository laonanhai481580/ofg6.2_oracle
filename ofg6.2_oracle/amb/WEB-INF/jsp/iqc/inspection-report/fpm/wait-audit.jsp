...
<head>
	...
	function hide(obj){
 		...
 		function(data){
 			  window.location.reload(href='${iqcctx}/inspection-report/fpm/wait-audit.htm');
			  alert("修改成功");
 		});
	}
	function selectTypeChange(obj){
		var selectType=$("#selectType").val();
		window.location.href = encodeURI('${iqcctx}/inspection-report/fpm/wait-audit.htm?selectType='+ selectType);
	}	
	</script>
</head>
...
<body onclick="$('#sysTableDiv').hide(); $('#styleList').hide();" >
	<script type="text/javascript">
		...
		var thirdMenu="waitAuditInspectionReport_fpm";
	</script>
			...
			<aa:zone name="main">
				<div class="opt-btn" id="btnDiv">
					...
					<security:authorize ifAnyGranted="IQC_INSPECTION-REPORT_LIST_EXPORT">
						<button class='btn' type="button" onclick="iMatrix.export_Data('${iqcctx}/inspection-report/fpm/export.htm?state=waitAudit');"><span><span><b class="btn-icons btn-icons-export"></b>导出</span></span></button>
					</security:authorize>
				...
				<div id="opt-content">
					<form id="contentForm" name="contentForm" method="post"  action="">
						<grid:jqGrid gridId="dynamicInspection"  url="${iqcctx}/inspection-report/fpm/wait-audit-list-datas.htm?selectType=${selectType}" code="IQC_IIAR_WAIT" pageName="page"></grid:jqGrid>
					</form>
				</div>
			</aa:zone>
		</div>
