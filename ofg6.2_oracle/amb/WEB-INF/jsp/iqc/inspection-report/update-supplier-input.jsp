...
<body>
	<div class="opt-body">
		<aa:zone name="main">
			<div class="opt-btn">
				<button class='btn'
					onclick="saveForm('${iqcctx}/inspection-report/update-supplier.htm')">
...
<%-- 						<tr>
							<td colspan="4">原供应商</td>
						</tr>
						<tr>
							<td >名称</td>
							<td>
								<input style="width: 120px;float: left;" type="hidden" name="supplierName" id="supplierName" value="${supplierName}" ></input>
								${supplierName}
							</td>
							<td >代码</td>
							<td>
								<input style="width: 120px;float: left;" type="hidden" name="supplierCode" id="supplierCode" value="${supplierCode}" ></input>
								${supplierCode}
							</td>
						</tr> --%>
						<tr>
							<td colspan="2">目标供应商</td>
							<td >状态</td>
							<td>
