...
<head>
	...
	function hide(obj){
 		...
 		function(data){
 			  window.location.reload(href='${iqcctx}/inspection-report/wait-audit.htm');
			  alert("修改成功");
 		});
	}
	//手动修改供应商
	...
	function selectTypeChange(obj){
		...
		window.location.href = encodeURI('${iqcctx}/inspection-report/wait-audit.htm?selectType='+ selectType);
	}
	</script>
</head>
...
<body onclick="$('#sysTableDiv').hide(); $('#styleList').hide();" >
	<script type="text/javascript">
		...
		var thirdMenu="waitAuditInspectionReport";
	</script>
			...
			<aa:zone name="main">
				...
				<div id="opt-content">
					<form id="contentForm" name="contentForm" method="post"  action="">
						<grid:jqGrid gridId="dynamicInspection"  url="${iqcctx}/inspection-report/wait-audit-list-datas.htm?selectType=${selectType}" code="IQC_IIAR_WAIT" pageName="page"></grid:jqGrid>
					</form>
				</div>
			</aa:zone>
		</div>
