...
<%
	String baseType = SampleCodeLetter.C0_TYPE;
%>
...
<head>
	...
	<script type="text/javascript">
		...
		function $beforeEditRow(rowId,iRow,iCol,e){
			var isRight = false;
			<security:authorize ifAnyGranted="IQC_SAMPLE-STANDARD_C0-SAMPLE_ADD">
				isRight =  true;
			</security:authorize>
			return isRight;
		}
		...
		<div class="opt-body">
			<aa:zone name="main">
				<div class="opt-btn">
					...
					<security:authorize ifAnyGranted="IQC_SAMPLE-STANDARD_C0-SAMPLE_DELETE">
