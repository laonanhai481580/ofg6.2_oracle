...
<%
	String baseType = SampleCodeLetter.MIL_TYPE;
%>
...
<head>
	...
	<script type="text/javascript">
		...
		function $beforeEditRow(rowId,iRow,iCol,e){
			var isRight = false;
			<security:authorize ifAnyGranted="IQC_SAMPLE-STANDARD_CODE-LETTER_CL-LIST_ADD">
				isRight =  true;
			</security:authorize>
			return isRight;
		}
		...
		<div class="opt-body">
			<aa:zone name="main">
				<div class="opt-btn">
					...
					<security:authorize ifAnyGranted="IQC_SAMPLE-STANDARD_CODE-LETTER_CL-LIST_DELETE">
				...
				<div id="opt-content">
					<form id="contentForm" name="contentForm" method="post" action="">
						<grid:jqGrid gridId="list" url="${iqcctx}/sample-standard/code-letter/cl-list-datas.htm" code="IQC_SAMPLE_CODE_LETTER_CL"></grid:jqGrid>
					</form>
				</div>
			</aa:zone>
		</div>
		...
		$(document).ready(function(){
			$("#list").jqGrid('setGroupHeaders', {
				  ...
				  groupHeaders:[
					...
					{startColumnName: 'validateLevel7', numberOfColumns: 7, titleText: '验证水平'}
				  ]
			});
		});
	</script>
