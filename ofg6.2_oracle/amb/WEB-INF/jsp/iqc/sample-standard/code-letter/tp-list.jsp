...
<head>
	...
	<script type="text/javascript">
		...
		function $beforeEditRow(rowId,iRow,iCol,e){
			var isRight = false;
			<security:authorize ifAnyGranted="IQC_SAMPLE-STANDARD_CODE-LETTER_TP-LIST_ADD">
				isRight =  true;
			</security:authorize>
			return isRight;
		}
		...
		<div class="opt-body">
			<aa:zone name="main">
				<div class="opt-btn">
					...
					<security:authorize ifAnyGranted="IQC_SAMPLE-STANDARD_CODE-LETTER_TP-LIST_DELETE">
				...
				<div id="opt-content">
					<form id="contentForm" name="contentForm" method="post" action="">
						<grid:jqGrid gridId="list" url="${iqcctx}/sample-standard/code-letter/tp-list-datas.htm" code="IQC_SAMPLE_CODE_LETTER"></grid:jqGrid>
					</form>
				</div>
			</aa:zone>
		</div>
