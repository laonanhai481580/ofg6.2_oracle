...
<head>
	...
	<script type="text/javascript">
		...
		function $beforeEditRow(rowId,iRow,iCol,e){
			var isRight = false;
			<security:authorize ifAnyGranted="iqc-ordinary-sample-scheme-mil-save">
				isRight =  true;
			</security:authorize>
			return isRight;
		}
...
<body onclick="$('#sysTableDiv').hide(); $('#styleList').hide();">
	<script type="text/javascript">
		...
		var treeMenu="mil-ordinary-sample";
	</script>
		...
		<div class="opt-body">
			<aa:zone name="main">
				<div class="opt-btn">
					...
					<security:authorize ifAnyGranted="iqc-ordinary-sample-scheme-mil-delete">
				...
				<div id="opt-content">
					<form id="contentForm" name="contentForm" method="post" action="">
						<grid:jqGrid gridId="list" url="${iqcctx}/sample-standard/ordinary-sample/mil-list-datas.htm" code="IQC_SAMPLE_SCHEME" dynamicColumn="${dynamicColumn}"></grid:jqGrid>
					</form>
					<script type="text/javascript">
