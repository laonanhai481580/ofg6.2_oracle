	...
	<script type="text/javascript">
		...
		function $processRowData(data){
 		...
 		function $beforeEditRow(rowId,iRow,iCol,e){
 			var isRight = false;
 			<security:authorize ifAnyGranted="iqc-relax-sample-scheme-mil-save">
 				isRight =  true;
 			</security:authorize>
			return isRight;
		}
		...
		<div class="opt-body">
			<aa:zone name="main">
				<div class="opt-btn">
					...
					<security:authorize ifAnyGranted="iqc-relax-sample-scheme-mil-delete">
				...
				<div id="opt-content">
					<form id="contentForm" name="contentForm" method="post" action="">
						<grid:jqGrid gridId="list" url="${iqcctx}/sample-standard/relax-sample/mil-list-datas.htm" code="IQC_SAMPLE_SCHEME_RELAX" dynamicColumn="${dynamicColumn}"></grid:jqGrid>
					</form>
					<script type="text/javascript">
