...
<%
	String baseType = SampleCodeLetter.ANSI_TYPE;
%>
<head>
	...
	<script type="text/javascript">
		...
		function $beforeEditRow(rowId,iRow,iCol,e){
			var isRight = false;
			<security:authorize ifAnyGranted="iqc-tighten-sampleScheme-tp-save">
				isRight =  true;
			</security:authorize>
			return isRight;
		}
...
<body onclick="$('#sysTableDiv').hide(); $('#styleList').hide();">
	<script type="text/javascript">
		...
		var treeMenu="tp-tighten-sample";
	</script>
	...
	<div class="ui-layout-center">
		<div class="opt-body">
			<aa:zone name="main">
				<div class="opt-btn">
					<security:authorize ifAnyGranted="iqc-tighten-sample-scheme-tp-save">
					<button class='btn' onclick="iMatrix.addRow();" type="button"><span><span><b class="btn-icons btn-icons-add"></b>新建</span></span></button>
					</security:authorize>
					<security:authorize ifAnyGranted="iqc-tighten-sampleScheme-tp-delete">
				...
				<div id="opt-content">
					<form id="contentForm" name="contentForm" method="post" action="">
						<grid:jqGrid gridId="list" url="${iqcctx}/sample-standard/tighten-sample/tp-list-datas.htm" code="IQC_SAMPLE_SCHEME_TIGHTEN" dynamicColumn="${dynamicColumn}"></grid:jqGrid>
					</form>
					<script type="text/javascript">
