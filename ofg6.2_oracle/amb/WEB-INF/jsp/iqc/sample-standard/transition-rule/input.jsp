					...
					<table class="form-table-border-left" style="width:100%;margin: auto;border-bottom:0px;" id="useBaseTypeTable">
						<tr height=29>
							 ...
							 <td style="padding-left:6px;border-bottom:0px;">
							 	...
							 	<input name="useBaseType" type="radio" value="<%=SampleCodeLetter.ANSI_TYPE%>" <%=SampleCodeLetter.ANSI_TYPE.equals(useBaseType)?"checked=checked":"" %>></input><%=SampleCodeLetter.ANSI_TYPE%>
							 	<input name="useBaseType" type="radio" value="<%=SampleCodeLetter.MIL_TYPE%>" <%=SampleCodeLetter.MIL105E_TYPE.equals(useBaseType)?"checked=checked":"" %>></input><%=SampleCodeLetter.MIL105E_TYPE%>
							 </td>
						</tr>
					</table>
