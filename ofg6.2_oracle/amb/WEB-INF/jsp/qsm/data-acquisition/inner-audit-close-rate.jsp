...
<body onclick="$('#sysTableDiv').hide(); $('#styleList').hide();" >
	<chart:view 
		chartDefinitionCode="qsm-inner-audit-close-rate"
		secMenu="analysis"
		secMenuJspPath="/menus/qsm-sec-menu.jsp"
		thirdMenu="inner_audt_close_rate"
		thirdMenuJspPath="/menus/qsm-analysis-third-menu.jsp"/>
</body>
</html>	
