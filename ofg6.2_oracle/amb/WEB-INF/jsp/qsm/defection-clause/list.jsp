...
<head>
	...
	<script type="text/javascript">
		...
		function $beforeEditRow(rowId,iRow,iCol,e){
			var isRight = false;
			<security:authorize ifAnyGranted="QSM_DEFECTION_CLAUSE_SAVE">
				isRight =  true;
			</security:authorize>
			return isRight;
		}	
		...
		function importDatas(){
			var url = encodeURI('${qsmctx}/defection-clause/import.htm');
		...
		function downloadTemplate(){
			window.location = '${qsmctx}/defection-clause/download-template.htm';
		}
	</script>
</head>
...
<body onclick="$('#sysTableDiv').hide(); $('#styleList').hide();" >
	<script type="text/javascript">
		var secMenu="defection_clause";
		var thirdMenu="_defection_clause";
	</script>
	...
	<div class="ui-layout-west">
		<%@ include file="/menus/qsm-defection-clause-third-menu.jsp"%>
	</div>
		...
		<div class="opt-body">
			...
			<aa:zone name="main">
				<div class="opt-btn">
					...
					<security:authorize ifAnyGranted="QSM_DEFECTION_CLAUSE_DELETE">
					...
					<security:authorize ifAnyGranted="QSM_DEFECTION_CLAUSE_EXPORT">
						<button class="btn" onclick="iMatrix.export_Data('${qsmctx}/defection-clause/export.htm');"><span><span><b class="btn-icons btn-icons-export"></b>导出</span></span></button>
					</security:authorize>
					<security:authorize ifAnyGranted="QSM_DEFECTION_CLAUSE_IMPORT">
				...
				<div id="opt-content" >
					<form id="contentForm" name="contentForm" method="post"  action="">
						<grid:jqGrid gridId="list" url="${qsmctx}/defection-clause/list-state.htm" submitForm="defaultForm" code="QSM_DEFECTION_CLAUSE" ></grid:jqGrid>
					</form>
				</div>
			</aa:zone>
		</div>
