		...
		<div class="opt-body">
			<aa:zone name="main">
				<div class="opt-btn">
					...
					<security:authorize ifAnyGranted="QSM_DEFECTION_CLAUSE_HIDE">
					<button class="btn" myType='settingData' onclick="iMatrix.setDataVisible(this);"><span><span>配置数据显示</span></span></button>
					</security:authorize>
				</div>
				<div id="opt-content">
					<form id="contentForm" method="post" action="" >
						<grid:jqGrid gridId="List" url="${qsmctx}/defection-clause/list-datas.htm" code="QSM_DEFECTION_CLAUSE"></grid:jqGrid>		
					</form>
				</div>
			</aa:zone>
		</div>
