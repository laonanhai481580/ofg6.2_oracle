...
<%-- 			<td>No.<input id="manageNo" name="manageNo" type="text" value="${manageNo}" /></td> --%>
		...
		<tr>
			<td style="width:160px;text-align:center;">计划审核时间</td>
			<td style="width:200px;">
				<input type="text"   id="yearAuditNo" name="yearAuditNo" value="${yearAuditNo}"/>
			</td>
			<td style="width:160px;text-align:center;">计划制定日期</td>
			<td style="width:200px;">
		...
		<tr style="background-color: CornflowerBlue;color: white;font-weight: bold;">
			<td style="width:200px;text-align: center;font-size: 18px;" colspan="6">内审报告及实施记录</td>
		</tr>	
		<tr>
			<td style="width:200px;" colspan="6">
		...
		<tr>
			<td style="width:160px;text-align:center;">内审总结报告</td>
			<td style="width:200px;" colspan="1">
				<input type="hidden"  isFile="true" id="attachment1" name="attachment1" value="${attachment1}"/>
			</td>
			<td style="width:160px;text-align:center;">查检表与不符合追踪记录</td>
			<td style="width:200px;" colspan="1">
				<input type="hidden"  isFile="true" id="auditFile1" name="auditFile1" value="${auditFile1}"/>
			</td>
			<td style="width:160px;text-align:center;">会议记录</td>
			<td style="width:200px;" colspan="1">
				<input type="hidden"  isFile="true" id="auditFile2" name="auditFile2" value="${auditFile2}"/>
			</td>
		</tr>
...
<%-- 				<input type="text"   id="department" isDept=true multiple=true name="department" value="${department}" style="width: 90%;border:none;text-align: center;background: none;"/>  --%>
				<input type="text" id="copyMan" isTemp="true" isUser="true"  multiple=true  hiddenInputId="copyLoginMan" style="float: left;width: 90%;"  name="copyMan" value="${copyMan}"  />
