...
<body onclick="$('#sysTableDiv').hide(); $('#styleList').hide();">
	<script type="text/javascript">
		...
		var thirdMenu="_correct_measures_list";
	</script>
	...
	<div class="ui-layout-center">
		<div class="opt-body">
			...
			<div class="opt-btn">
				...
				<security:authorize ifAnyGranted="QSM_CORRECT_MEASURES_DELETE">
					<button class="btn" onclick="iMatrix.delRow();">
						<span><span><b class="btn-icons btn-icons-delete"></b>删除</span></span>
					</button>
				</security:authorize>
				<security:authorize ifAnyGranted="QSM_CORRECT_MEASURES_IMPORT">
				...
				<security:authorize ifAnyGranted="QSM_CORRECT_MEASURES_EXPORT">
					<button class='btn'
			...
			<div id="opt-content">
				<form id="contentForm" name="contentForm" method="post" action="">
					<grid:jqGrid gridId="list" url="${actionBaseCtx}/list-state.htm"
						submitForm="defaultForm" code="QSM_CORRECT_MEASURES"></grid:jqGrid>
				</form>
			</div>
		</div>
	</div>
