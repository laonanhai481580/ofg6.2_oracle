...
<body onclick="$('#sysTableDiv').hide(); $('#styleList').hide();">
	<script type="text/javascript">
		...
		var thirdMenu="_year_audit_list";
	</script>
	...
	<div class="ui-layout-center">
		<div class="opt-body">
			...
			<div class="opt-btn">
				...
				<security:authorize ifAnyGranted="QSM_YEAR_AUDIT_DELETE">
				...
				<security:authorize ifAnyGranted="QSM_YEAR_AUDIT_EXPORT">
					<button class='btn'
			...
			<div id="opt-content">
				<form id="contentForm" name="contentForm" method="post" action="">
					<grid:jqGrid gridId="list" url="${actionBaseCtx}/list-state.htm"
						submitForm="defaultForm" code="QSM_YEAR_AUDIT"></grid:jqGrid>
				</form>
			</div>
		</div>
	</div>
