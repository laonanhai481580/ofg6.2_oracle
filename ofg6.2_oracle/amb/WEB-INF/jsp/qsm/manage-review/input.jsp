...
<script type="text/javascript">
	...
	function setValues(obj){
		...
		$("#__multiselect_systemName").val(values.toString());
	}		
	/**
	导出表单
	*	
...
<body onload="getContentHeight();">
	<script type="text/javascript">
		...
		var thirdMenu="_manage_review_input";
	</script>
		...
		<div class="opt-body">
			<aa:zone name="main">
				<div class="opt-btn">
					...
					<s:else>
						<security:authorize ifAnyGranted="QSM_MANAGE_REVIEW_SAVE">
					...
					<c:if test="${id>0}">
						<security:authorize ifAnyGranted="QSM_MANAGE_REVIEW_EXPORT_FORM">
