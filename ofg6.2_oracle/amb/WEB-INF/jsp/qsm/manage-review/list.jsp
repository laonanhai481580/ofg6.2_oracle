...
<c:set var="actionBaseCtx" value="${qsmctx}/manage-review" />
<script type="text/javascript">
		var buttonSign="";
		function addForm(){
...
<body onclick="$('#sysTableDiv').hide(); $('#styleList').hide();">
	<script type="text/javascript">
		var secMenu="manage_review";
		var thirdMenu="_manage_review_list";
	</script>
	...
	<div class="ui-layout-west">
		<%@ include file="/menus/qsm-manage-review-third-menu.jsp"%>
	</div>
	...
	<div class="ui-layout-center">
		<div class="opt-body">
			...
			<div class="opt-btn">
				...
				<security:authorize ifAnyGranted="QSM_MANAGE_REVIEW_DELETE">
				...
				<security:authorize ifAnyGranted="QSM_MANAGE_REVIEW_IMPORT">
				...
				<security:authorize ifAnyGranted="QSM_MANAGE_REVIEW_EXPORT">
					<button class='btn'
			...
			<div id="opt-content">
				<form id="contentForm" name="contentForm" method="post" action="">
					<grid:jqGrid gridId="list" url="${actionBaseCtx}/list-state.htm"
						submitForm="defaultForm" code="QSM_MANAGE_REVIEW"></grid:jqGrid>
				</form>
			</div>
		</div>
	</div>
