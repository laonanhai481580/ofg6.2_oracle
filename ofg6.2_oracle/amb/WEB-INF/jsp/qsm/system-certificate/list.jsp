...
<head>
	...
	<script type="text/javascript">
		...
		function $beforeEditRow(rowId,iRow,iCol,e){
			var isRight = false;
			<security:authorize ifAnyGranted="QSM_SYSTEM_CERTIFICATE_SAVE">
				isRight =  true;
			</security:authorize>
			return isRight;
		}	
...
<body onclick="$('#sysTableDiv').hide(); $('#styleList').hide();" >
	<script type="text/javascript">
		var secMenu="system_certificate";
		var thirdMenu="_system_certificate";
	</script>
	...
	<div class="ui-layout-west">
		<%@ include file="/menus/qsm-system-certificate-third-menu.jsp"%>
	</div>
		...
		<div class="opt-body">
			...
			<aa:zone name="main">
				<div class="opt-btn">
					...
					<security:authorize ifAnyGranted="QSM_SYSTEM_CERTIFICATE_DELETE">
					...
					<security:authorize ifAnyGranted="QSM_SYSTEM_CERTIFICATE_EXPORT">
						<button class="btn" onclick="iMatrix.export_Data('${qsmctx}/system-certificate/export.htm');"><span><span><b class="btn-icons btn-icons-export"></b>导出</span></span></button>
					</security:authorize>
				...
				<div id="opt-content" >
					<form id="contentForm" name="contentForm" method="post"  action="">
						<grid:jqGrid gridId="list" url="${qsmctx}/system-certificate/list-state.htm" submitForm="defaultForm" code="QSM_SYSTEM_CERTIFICATE" ></grid:jqGrid>
					</form>
				</div>
			</aa:zone>
		</div>
