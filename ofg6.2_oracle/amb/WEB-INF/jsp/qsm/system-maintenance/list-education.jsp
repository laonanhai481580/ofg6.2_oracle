...
<head>
	...
	<script type="text/javascript">
		...
		function $beforeEditRow(rowId,iRow,iCol,e){
			var isRight = false;
			<security:authorize ifAnyGranted="QSM_SYSTEM_MAINTENANCE_SAVE">
				isRight =  true;
			</security:authorize>
			return isRight;
		}	
...
<body onclick="$('#sysTableDiv').hide(); $('#styleList').hide();" >
	<script type="text/javascript">
		...
		var thirdMenu="_system_maintenance_education";
	</script>
		...
		<div class="opt-body">
			...
			<aa:zone name="main">
				<div class="opt-btn">
					...
					<security:authorize ifAnyGranted="QSM_SYSTEM_MAINTENANCE_DELETE">
					...
					<security:authorize ifAnyGranted="QSM_SYSTEM_MAINTENANCE_EXPORT">
						<button class="btn" onclick="iMatrix.export_Data('${qsmctx}/system-maintenance/export.htm');"><span><span><b class="btn-icons btn-icons-export"></b>导出</span></span></button>
					</security:authorize>
				...
				<div id="opt-content" >
					<form id="contentForm" name="contentForm" method="post"  action="">
						<grid:jqGrid gridId="list" url="${qsmctx}/system-maintenance/list-menutype.htm?menutype=PX" submitForm="defaultForm" code="QSM_SYSTEM_EDUCATION_LIST" ></grid:jqGrid>
					</form>
				</div>
			</aa:zone>
		</div>
