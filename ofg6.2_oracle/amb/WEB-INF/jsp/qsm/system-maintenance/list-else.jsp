...
<body onclick="$('#sysTableDiv').hide(); $('#styleList').hide();" >
	<script type="text/javascript">
		...
		var thirdMenu="_system_maintenance_legal";
	</script>
			...
			<aa:zone name="main">
				...
				<div id="opt-content" >
					<form id="contentForm" name="contentForm" method="post"  action="">
						<grid:jqGrid gridId="list" url="${qsmctx}/system-maintenance/list-menutype.htm?menutype=QT" submitForm="defaultForm" code="QSM_SYSTEM_ELSE_LIST" ></grid:jqGrid>
					</form>
				</div>
			</aa:zone>
		</div>
