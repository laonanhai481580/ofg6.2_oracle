...
<body onclick="$('#sysTableDiv').hide(); $('#styleList').hide();" >
	<script type="text/javascript">
		...
		var thirdMenu="_system_maintenance_risk";
	</script>
			...
			<aa:zone name="main">
				...
				<div id="opt-content" >
					<form id="contentForm" name="contentForm" method="post"  action="">
						<grid:jqGrid gridId="list" url="${qsmctx}/system-maintenance/list-menutype.htm?menutype=FL" submitForm="defaultForm" code="QSM_SYSTEM_LEGAL_LIST" ></grid:jqGrid>
					</form>
				</div>
			</aa:zone>
		</div>
