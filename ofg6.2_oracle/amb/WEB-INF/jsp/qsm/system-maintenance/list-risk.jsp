...
<body onclick="$('#sysTableDiv').hide(); $('#styleList').hide();" >
	<script type="text/javascript">
		...
		var thirdMenu="_system_maintenance_else";
	</script>
			...
			<aa:zone name="main">
				...
				<div id="opt-content" >
					<form id="contentForm" name="contentForm" method="post"  action="">
						<grid:jqGrid gridId="list" url="${qsmctx}/system-maintenance/list-menutype.htm?menutype=FX" submitForm="defaultForm" code="QSM_SYSTEM_RISK_LIST" ></grid:jqGrid>
					</form>
				</div>
			</aa:zone>
		</div>
