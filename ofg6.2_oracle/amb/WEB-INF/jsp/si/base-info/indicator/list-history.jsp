	...
	<div class="ui-layout-center">
		<div class="opt-body">
			<aa:zone name="main">
				...
				<security:authorize ifAnyGranted="SI_BASE-INFO_INSPECTION-BASE-INDICATOR_EXPORT">
				<button  class='btn' type="button" onclick="iMatrix.export_Data('${sictx}/base-info/indicator/export-history.htm?materielCode=${materielCode}&workingProcedure=${workingProcedure}');"><span><span><b class="btn-icons btn-icons-import"></b>导出</span></span></button>
				</security:authorize>
				...
				<div id="opt-content">
					<form id="contentForm" name="contentForm" method="post" action="" >
						<grid:jqGrid gridId="evaluatingIndicatorList" url="${sictx}/base-info/indicator/list-history-datas.htm?materielCode=${materielCode}&workingProcedure=${workingProcedure}" code="SI_INSPECTING_INDICATOR" pageName="page"></grid:jqGrid>
					</form>
				</div>
			</aa:zone>
		</div>
