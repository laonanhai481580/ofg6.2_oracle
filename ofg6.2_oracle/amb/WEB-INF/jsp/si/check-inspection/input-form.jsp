...
%> 
	...
	<table style="width:100%;margin: auto;" class="form-table-border-left" id="default-table">
		...
		<tr>
			...
			<td style="width:10%">欧菲机型<span style="color:red">*</span></td>
			<td>
				<input id="machineType" name="machineType" value="${machineType}" onclick="modelClick(this);"/>
			</td>
		...
		<tr>
			...
			<td style="width:10%"><span style="color:red">*</span>检验数</td>
			<td>
				<input id="inspectionAmount" name="inspectionAmount" value="${inspectionAmount}" class="{required:true,messages:{required:'必填'}}"/>
			</td>
			<td style="width:10%"><span style="color:red">*</span>合格数</td>
			<td style="">
				<input id="qualifiedAmount" name="qualifiedAmount" value="${qualifiedAmount}" class="{required:true,messages:{required:'必填'}}"/>
			</td>	
		</tr>
		<tr>					
