	...
	<div id="detail">
		...
		<table cellpadding="0" cellspacing="0"  align="center" class="form-table-border-left" style="margin-top: 10px;width: 95%;">
			<tr>
				...
				<td><input id="pointCode" name="pointCode" value="${pointCode }" class="{required:true}"/></td>
				<td style="width:90px"><span style="color:red;">*</span>监控点名称:</td>
				<td><input id="pointName" name="pointName" value="${pointName }" class="{required:true}"/> </td>
			</tr>
			<tr>
				<td style="width:90px"><span style="color:red;">*</span>编&nbsp;辑&nbsp;人:</td>
				<td><input id='pointEditer' name='pointEditer' value='${pointEditer }' onclick="selectPerson(this)" readonly="readonly" class="{required:true}"/></td>
			...
			<td style="width:90px"></span>是否显示CPK:</td>
				<td colspan="3"><input id='params.isCpk' name='params.isCpk'  type="checkbox" class="{required:true}"  value="Y" <s:if test="isCpk==\"Y\""> checked="checked" </s:if>/></td>
			</tr>
			<tr>
