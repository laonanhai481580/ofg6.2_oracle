...
<title>过程节点属性</title>
	...
	<script type="text/javascript">
		...
		function submitForm(url){
			if($("#monitForm").valid()){
				var params = {};
				$("#monitForm :input[name]").each(function(index,obj){
				...
				<form id="monitForm" name="monitForm" method="post">
					...
					<table cellpadding="0" cellspacing="0" width="100%" align="center">
						...
						<tr>
							...
							<td><input id='editDate' name='editDate' value='<s:date name="editDate" format="yyyy-MM-dd"/>' readonly="readonly" class="line"/></td>
						</tr>
						<tr>
							<td style="width:90px"><span style="color:red;">*</span>类别描述:</td>
							<td colspan="3"><textarea id='categoryDescription' name='categoryDescription' rows="10" style="width:450px;" >${categoryDescription }</textarea></td>
						</tr>
					</table>
				</form>
			</div>
