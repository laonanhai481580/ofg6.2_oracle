...
<title>安必兴—企业管理效率促进专家</title>
	...
	<script type="text/javascript">
		...
		function loadPicByMonitorId(monitorId){
			if(monitorId){
				$("#monitorProgramId").val(monitorId);
				var picurl='${spcctx }/base-info/monitor-program/monitor-program-pic.htm?monitorProgramId='+monitorId+"&nowtime=" + (new Date()).getTime();
				$("#pic").load(picurl,function(){
					refsh();
				});
			}else{
				$("#monitorProgramId").val('');
				$("#monitorImage").attr("src","");
				$(".light").remove();
			}
		}
	</script>
