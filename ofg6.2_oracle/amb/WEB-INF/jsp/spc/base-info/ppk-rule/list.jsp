...
<body onclick="$('#sysTableDiv').hide(); $('#styleList').hide();" >
	...
	<div class="ui-layout-center">
		<div class="opt-body">
			<aa:zone name="main">
				<div class="opt-btn">
					<security:authorize ifAnyGranted="spc-ppkRule-input">
					...
					<security:authorize ifAnyGranted="spc-ppkRule-delete">
				...
				<div id="opt-content">
					<form id="contentForm"  method="post"  action="">
						<grid:jqGrid gridId="ppkRuleList"  url="${spcctx}/base-info/ppk-rule/list-datas.htm" code="SPC_PPK_RULE" pageName="page"></grid:jqGrid>
					</form>
				</div>
			</aa:zone>
		</div>
