...
<div id="tabs-1" style="padding:0px;">
	<span id="info-message" style="color: red; padding-left: 4px; font-weight: bold;"></span>
   	<table style="width:100%;margin:0px;padding:0px;text-align: center;">
   		<input type="hidden" id="id" name="id" value="${qualityFeature.id }"/>
		<tr>
			<td colspan="2" valign="middle" style="width:100%;">
				<fieldSet> 
					<table>
						<tr>
							<td>名称：</td>
							<td><input name="name" value="${qualityFeature.name }"/></td>
							<td colspan="2">&nbsp;&nbsp;</td>
							<td style="width:188px;text-align: right;">简码：</td>
							<td><input name="code" value="${qualityFeature.code }"/></td>
						</tr>
						<tr>
			    ...
			    <fieldSet> 
			    	<table>
			    		<tr>
			    			...
			    			<td align="left"><input style="width: 160px;" name="sampleCapacity" id="sampleCapacity" value="${qualityFeature.sampleCapacity}" class="{digits:true,min:0}" onchange="$('#effectiveCapacity').val(this.value)"/></td>
			    		</tr>
			    		<tr>
			    		...
			    		<tr>
			    			<td align="right">合理上限：</td>
			    			<td align="left"><input style="width: 160px;" name="upperLimit" id="upperLimit" value="${qualityFeature.upperLimit}"/></td>
			    		</tr>
			    		<tr>
			    			<td align="right">合理下限：</td>
			    			<td align="left"><input style="width: 160px;" name="lowerLimit" id="lowerLimit" value="${qualityFeature.lowerLimit}"/></td>
			    		</tr>
			    		<tr>
			    			<td></td>
...
<!-- 		//检查历史数据并判断是否发起异常 -->
		<security:authorize ifAnyGranted="spc_base-info_process-define_save">
			<button class='btn' type="button" onclick="lanchAbnormalHis();"><span><span><b class="btn-icons btn-icons-checked"></b>检查历史数据</span></span></button>
		</security:authorize>				
