							...
							<td style="width:50%;">
								<span>
									<security:authorize ifAnyGranted="spc_common_feature-bom-select">
										...
										<input name="featureName" id="featureName" value="${qualityFeature.name}" style="width:150px;vertical-align: middle;border: none;" readonly="readonly"/>
										...
										<input name="featureId" id="featureId" type="hidden"  value="${qualityFeature.id}" />
