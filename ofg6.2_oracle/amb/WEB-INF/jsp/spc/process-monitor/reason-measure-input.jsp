	...
	<div class="ui-layout-center">
		<div class="opt-body">
			<div class="opt-btn">
				...
				%>
				<security:authorize ifAnyGranted="spc_process-monitor_save">
					<button class="btn" onclick="submitForm('${spcctx}/process-monitor/save.htm?messageId=<%=messageId%>')">
					...
					<table class="form-table-without-border" style="width:100%;margin: auto;">
						...
						<tr>
							<td style="width: 100%;" align="center">
								<a class="small-button-bg" style="float: right;" onclick="selectReasons(this);" href="javascript:void(0);" title="添加原因"><span class="ui-icon ui-icon-search" style='cursor: pointer;'></span></a>
							</td>
						</tr>
						<tr>
							<td style="width: 100%;" align="center">
