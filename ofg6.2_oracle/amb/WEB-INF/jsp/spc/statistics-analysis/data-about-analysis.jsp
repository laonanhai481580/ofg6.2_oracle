...
<script type="text/javascript">
	...
	function setFeatureValue(datas){	
		$("#"+featureId+"qualityFeature").val(datas[0].id);
		$("#"+featureId).val(datas[0].value);
	}	
						...
						<table class="form-table-outside-border"  style="width:100%;padding:4px;">
							...
							<tr>
								<td colspan="2">
									...
									<input style="border: none;" name="x" id="x" onclick="selectFeature(this);" readonly="readonly"/>
									<input name="xqualityFeature" id="xqualityFeature" type="hidden"/>
								</td>
								<td colspan="2">
									自变量(Y):
									...
									<input style="border: none;" name="y" id="y" onclick="selectFeature(this);" readonly="readonly"/>
									<input name="yqualityFeature" id="yqualityFeature" type="hidden"/>
								</td>
							</tr>
						</table>
