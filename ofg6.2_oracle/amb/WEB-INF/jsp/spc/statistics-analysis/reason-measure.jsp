...
// 		createGrid();
	...
	function createGrid(){
		...
		$("#gridList").jqGrid({
			...
			colNames:['id','工厂名称','质量特性模块','质量特性总称','质量特性','异常','子组号','检测时间','原因','原因时间','责任人','改善措施','改善时间','责任人','分析原因结束时间','采取措施时间'], 
			colModel:[
				{name:'id',index:'id',hidden:true},
				{name:'qualityFeature.processPoint.parent.parent.name',index:'qualityFeature.processPoint.parent.parent.name'},
				{name:'qualityFeature.processPoint.parent.name',index:'qualityFeature.processPoint.parent.name'},
				{name:'qualityFeature.processPoint.name',index:'qualityFeature.processPoint.name'},
...
<!-- 									<div id="pager"></div> -->
										<grid:jqGrid gridId="gridList" url="${spcctx}/statistics-analysis/list-datas.htm" submitForm="sForm"  code="SPC_REASON_MEASURE"></grid:jqGrid>
								</td>
							</tr>
						</table>
					</div>
