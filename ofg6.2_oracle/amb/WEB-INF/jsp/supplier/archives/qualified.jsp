...
<script type="text/javascript">
	...
	function sendCalcleSuppliers(){
		...
		var url='${supplierctx}/archives/supplier-cancle.htm?id='+ids;
		$.post(encodeURI(url),params,function(result){
			...
			$("#suppliers").jqGrid("setGridParam").trigger("reloadGrid");
		},'json');
	} 
...
<%-- 				<security:authorize ifAnyGranted="archives-qualified-evaluate-add"> --%>
				...
				<security:authorize ifAnyGranted="archives-qualified-hidden-supplier">
				    <button class="btn" onclick="hiddenSupplier();"><span><span><b class="btn-icons btn-icons-audit"></b>隐藏供应商数据</span></span></button>
				</security:authorize>
			...
			<security:authorize ifAnyGranted="supplier-add">					
				 <s:select list="systemCodes" 
							...
							listValue="name" 
							id="systemCode"
							onchange="systemCodeChange('archives/qualified.htm')"
							cssStyle="width:60px"
							emptyOption="false"
							labelSeparator="">
				</s:select> 
