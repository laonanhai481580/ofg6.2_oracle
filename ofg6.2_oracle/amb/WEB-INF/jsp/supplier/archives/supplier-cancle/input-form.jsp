...
<%-- 	            <input  name="managerIdeal" id="managerIdeal"  value="${managerIdeal}" /> --%>
	     ...
	     <tr>
	     	<td>采购确认</td>
	     	 <td >经办人</td>
	         <td>
	              <input style="float:left;" hiddenInputId="purchaseLog" isUser="true" id="purchase" name="purchase" value="${purchase}"/>
	              <input type="hidden" name="purchaseLog" id="purchaseLog"  value="${purchaseLog}" />
                  <a class="small-button-bg" style="margin-left:2px;" onclick="clearValue('purchase','purchaseLog')" href="javascript:void(0);" title="<s:text name='清空'/>"><span class="ui-icon ui-icon-trash" style='cursor:pointer;'></span>
	         </td>
	         <td>采购意见</td>
	         <td colspan=""><textarea style="width: 98%;" id="purchaseOpinion" name="purchaseOpinion">${purchaseOpinion }</textarea></td>
	     	<td></td>
	     </tr>
	</tbody> 	 
</table>
