...
<head>
	...
	<script type="text/javascript">
		...
		function $beforeEditRow(rowId,iRow,iCol,e){
			var isRight = false;
			<security:authorize ifAnyGranted="SUPPLIER_DEFECTION_ITEM_SAVE">
			  isRight =  true;
			</security:authorize>
			return isRight;
		}
		...
		<div class="opt-body">
			<aa:zone name="main">
				...
				<security:authorize ifAnyGranted="SUPPLIER_DEFECTION_ITEM_SAVE">
					...
					<security:authorize ifAnyGranted="SUPPLIER_DEFECTION_ITEM_DELETE">
					...
					<security:authorize ifAnyGranted="SUPPLIER_DEFECTION_ITEM_EXPORT">
					<button  class='btn' type="button" onclick="iMatrix.export_Data('${supplierctx}/base-info/defection-item/exportCode2.htm?defectionClassId='+<%=defectionClassId%>);"><span><span><b class="btn-icons btn-icons-export"></b>导出</span></span></button>
					</security:authorize>
					<span style="color:red;font-size:18px;" >* <span style="font-family:verdana;color:red;font-size:10px;">双击可编辑,Enter(回车)可保存.</span></span>
				</div>
				<div id="opt-content">
					<form id="contentForm" method="post" action="" >
						<grid:jqGrid gridId="defectionItemList" url="${supplierctx}/base-info/defection-item/list-datas.htm" code="SUPPLIER_DEFECTION_ITEM"></grid:jqGrid>		
					</form>
				</div>
			</aa:zone>
		</div>
