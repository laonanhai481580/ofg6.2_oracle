	...
	<div class="ui-layout-center">
		<div class="opt-body">
			<div class="opt-btn">
				...
				<security:authorize ifAnyGranted="supplier-base-info-level-score-setting-datas">
				...
				<security:authorize ifAnyGranted="supplier-add">					
					 <s:select list="systemCodes" 
								...
								listValue="name" 
								id="systemCode"
								onchange="systemCodeChange('base-info/level-score/list.htm')"
								cssStyle="width:60px"
								emptyOption="false"
								labelSeparator="">
					</s:select> 
