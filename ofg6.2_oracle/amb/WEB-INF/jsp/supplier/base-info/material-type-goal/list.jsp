...
<body onclick="$('#sysTableDiv').hide(); $('#styleList').hide();">
	<script type="text/javascript">
		...
		var treeMenu = "materialTypeGoallist";
	</script>
	...
	<div class="ui-layout-center">
		<div class="opt-body">
			<div class="opt-btn">
				<security:authorize ifAnyGranted="supplier-base-info-material-type-goal-save">
				    <button class='btn' onclick="iMatrix.addRow();"><span><span><b class="btn-icons btn-icons-add"></b>新建</span></span></button>
				</security:authorize>
				<security:authorize ifAnyGranted="supplier-base-info-material-type-goal-delete">
			...
			<security:authorize ifAnyGranted="supplier-add">					
				 <s:select list="systemCodes" 
							...
							listValue="name" 
							id="systemCode"
							onchange="systemCodeChange('base-info/material-type-goal/list.htm')"
							cssStyle="width:60px"
							emptyOption="false"
							labelSeparator="">
				</s:select> 
