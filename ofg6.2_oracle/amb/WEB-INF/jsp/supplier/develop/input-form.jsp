...
<table style="width:100%;margin: auto;" class="form-table-border-left" id="default-tabl">
	<tbody>
	     ...
	     <tr>
	         <td>供应商名称</td>
	         <td colspan="3">
	            <input id="supplierName" style="width:96%;float:left;" name="supplierName" value="${supplierName }"/>
	         </td>
	         <td>供应商编号</td>
	         <td><input id="supplierCode" style="width:96%;float:left;" name="supplierCode" value="${supplierCode }"/></td>
	     </tr>
	     <tr>
	         <td>提供产品/服务范围</td>
	         <td colspan="5"><textarea id="supplierServices" style="width:98%;" name="supplierServices" >${supplierServices}</textarea></td>
	     </tr>
	     <tr>
	         <td>公司地址</td>
	         <td colspan="5"><textarea id="supplierCompanyAddress" style="width:98%;" name="supplierCompanyAddress" >${supplierCompanyAddress}</textarea></td>
	     </tr>
	     <tr>
	         <td>营业执照号码</td>
	     ...
	     <tr>
	         <td>备注</td>
	         <td colspan="5" ><textarea height="5" id="remark" style="width:98%;" name="remark"  onkeydown="changeTextarea (this);">${remark}</textarea></td>
	     </tr>
	     <tr>
	         <td>基本信息</td>
