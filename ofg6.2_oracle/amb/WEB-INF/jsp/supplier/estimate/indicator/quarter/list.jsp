...
<body onclick="$('#sysTableDiv').hide(); $('#styleList').hide();">
	<script type="text/javascript">
		...
		var treeMenu = "_estimate_indicator";
	</script>
		...
		<div class="opt-body">
			<aa:zone name="main">
				<div class="opt-btn" style="line-height:30px;">
					...
					<span id="message" style="margin-left:4px;color:red;">X:进料批合格率目标,Y:上线不良率目标</span> 
				</div>
				...
				<security:authorize ifAnyGranted="supplier-add">					
					 <s:select list="systemCodes" 
								...
								listValue="name" 
								id="systemCode"
								onchange="systemCodeChange('estimate/indicator/quarter/list.htm')"
								cssStyle="width:60px"
								emptyOption="false"
								labelSeparator="">
					</s:select> 
