	...
	<div class="ui-layout-center">
		<div class="opt-body">
			...
			<div class="opt-btn">
				...
				<s:else>
				<security:authorize ifAnyGranted="supplier-evaluate-save">
				...
				<c:if test="${id>0}">
					<security:authorize ifAnyGranted="supplier-evaluate_export">
