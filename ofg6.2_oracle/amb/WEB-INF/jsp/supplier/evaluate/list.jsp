...
<head>
	...
	<c:set var="actionBaseCtx" value="${supplierctx}/evaluate"/>
	...
	<div class="ui-layout-center">
		<div class="opt-body">
			<aa:zone name="main">
				...
				<security:authorize ifAnyGranted="supplier_evaluate_delete">
				...
				<security:authorize ifAnyGranted="supplier_evaluate_export">
				    <button  class='btn' onclick="iMatrix.export_Data('${supplierctx}/evaluate/quarter/export.htm');" type="button"><span><span><b class="btn-icons btn-icons-export"></b>导出</span></span></button>		
				</security:authorize> 
 				</div>
				<div id="opt-content">
					<form id="contentForm" method="post" action="" >
						<grid:jqGrid gridId="dynamicComplain" url="${actionBaseCtx}/list-datas.htm" code="SUPPLIER_EVALUATE" pageName="page" ></grid:jqGrid>
					</form>
				</div>
			</aa:zone>
		</div>
