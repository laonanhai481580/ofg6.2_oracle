		...
		<div class="opt-body">
			<aa:zone name="main">
				<div class="opt-btn">
					...
					<security:authorize ifAnyGranted="supplier-improve-export-hide">
					...
					<security:authorize ifAnyGranted="supplier-add">					
						<div style="float:right;position:absolute; right:50px;top:6px;" >
						 <s:select list="systemCodes" 
									...
									listValue="name" 
									id="systemCode"
									onchange="systemCodeChange('improve/hide-list.htm')"
									cssStyle="width:60px"
									emptyOption="false"
									labelSeparator="">
						</s:select> 
				...
				<div id="opt-content">
					<form id="contentForm" method="post" action="" >
						<grid:jqGrid gridId="dynamicComplain" url="${actionBaseCtx}/hide-list-datas.htm" code="SUPPLIER_IMPROVE" pageName="page" ></grid:jqGrid>
					</form>
				</div>
			</aa:zone>
		</div>
