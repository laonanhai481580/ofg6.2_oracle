...
<input type="hidden" name="onlyView" id="onlyView" value="${onlyView}" />
	<script type="text/javascript">
		...
		if(onlyView=='true'){
			thirdMenu="improveListAll";
		}else{
			thirdMenu="improveList1";
		}
 	</script>
	...
	<div class="ui-layout-center">
		<div class="opt-body">
			...
			<c:if test="${onlyView!=true}">
				...
				<s:else>
				<security:authorize ifAnyGranted="supplier-exception-improve-save">
				...
				<s:if test="task.active==0&&returnableTaskNames.size>0">
					<security:authorize ifAnyGranted="supplier-exception-improve-renturn">
				...
				<c:if test="${id>0}">
					<security:authorize ifAnyGranted="supplier-exception-improve-export-report">
