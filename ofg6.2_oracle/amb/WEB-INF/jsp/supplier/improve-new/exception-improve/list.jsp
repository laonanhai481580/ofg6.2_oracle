...
<body onclick="$('#sysTableDiv').hide(); $('#styleList').hide();" >
	...
	<div class="ui-layout-center">
		<div class="opt-body">
			<aa:zone name="main">
				<div class="opt-btn">
					<security:authorize ifAnyGranted="supplier-exception-improve-delete">
					...
					<security:authorize ifAnyGranted="supplier-exception-improve-export">
					...
					<security:authorize ifAnyGranted="supplier-add">					
						 <s:select list="systemCodes" 
									...
									listValue="name" 
									id="systemCode"
									onchange="systemCodeChange('improve-new/exception-improve/list.htm')"
									cssStyle="width:60px"
									emptyOption="false"
									labelSeparator="">
						</s:select> 
				...
				<div id="opt-content">
					<form id="contentForm" method="post" action="" >
						<grid:jqGrid gridId="dynamicComplain" url="${actionBaseCtx}/list-datas.htm?selectType=${selectType}" code="SUPPLIER_EXCEPTION_IMPROVE" pageName="page" ></grid:jqGrid>
					</form>
				</div>
			</aa:zone>
		</div>
