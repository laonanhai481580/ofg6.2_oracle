...
<%-- 	          <td>核准</td>
	     ...
	     <tr>
	         ...
	         <td>MRB申请</td>
	         <td>
	            <input type="radio" id="mrbApply1" name="mrbApply" value="需要" <s:if test="mrbApply=='需要'">checked="true"</s:if> title="需要" onchange="mrbApplyChange(this);"/><label for="mrbApply1">需要</label>
	            <input type="radio" id="mrbApply2" name="mrbApply" value="不需要" <s:if test="mrbApply=='不需要'">checked="true"</s:if> checked="checked" title="不需要" onchange="mrbApplyChange(this);"/><label for="mrbApply2">不需要</label>
	         </td>
	     ...
	     <tr>
	         <td>处理意见</td>
	         <td>
                <input type="radio" id="sqeProcessOpinion1" onclick="setReturnReportNoRequired(this);" name="sqeProcessOpinion" value="特采" <s:if test="sqeProcessOpinion=='特采'">checked="true"</s:if> title="特采" onchange="sqeProcessOpinionChange(this);"/><label for="sqeProcessOpinion1">特采</label>
	            <input type="radio" id="sqeProcessOpinion2" onclick="setReturnReportNoRequired(this);" name="sqeProcessOpinion" value="退货" <s:if test="sqeProcessOpinion=='退货'">checked="true"</s:if> title="退货" onchange="sqeProcessOpinionChange(this);"/><label for="sqeProcessOpinion2">退货</label>
	            <input type="radio" id="sqeProcessOpinion3" onclick="setReturnReportNoRequired(this);" name="sqeProcessOpinion" value="返修" <s:if test="sqeProcessOpinion=='返修'">checked="true"</s:if> title="返修" onchange="sqeProcessOpinionChange(this);"/><label for="sqeProcessOpinion3">返修</label>
	            <input type="radio" id="sqeProcessOpinion4" onclick="setReturnReportNoRequired(this);" name="sqeProcessOpinion" value="挑选" <s:if test="sqeProcessOpinion=='挑选'">checked="true"</s:if> checked="checked" title="挑选" onchange="sqeProcessOpinionChange(this);"/><label for="sqeProcessOpinion4">挑选</label>
             </td>
