			...
			<aa:zone name="main">
				<div class="opt-btn">
					...
					<security:authorize ifAnyGranted="supplier-add">					
						 <s:select list="systemCodes" 
									...
									listValue="name" 
									id="systemCode"
									onchange="systemCodeChange('improve/list.htm')"
									cssStyle="width:60px"
									emptyOption="false"
									labelSeparator="">
						</s:select> 
				...
				<div id="opt-content">
					<form id="contentForm" method="post" action="" >
						<grid:jqGrid gridId="dynamicComplain" url="${actionBaseCtx}/list-datas.htm?selectType=${selectType}" code="SUPPLIER_IMPROVE" pageName="page" ></grid:jqGrid>
					</form>
				</div>
			</aa:zone>
		</div>
