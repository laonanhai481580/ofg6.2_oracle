...
<table class="form-table-border-left" style="border:0px; table-layout: fixed;">
	<tbody>
			...
			<tr class="supplierAdmitFiles" zbtr2=true>
				...
				<td style="text-align: center;"><input style="width: 95%;" stage="one" name="auditDepartment" value="${auditDepartment}" /></td>
				<td style="text-align: center;"><input style="width: 95%;" stage="one" name="materialName" value="${materialName}"/></td>
