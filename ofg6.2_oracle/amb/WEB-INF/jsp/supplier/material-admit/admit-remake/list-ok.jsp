		...
		<div class="opt-body">
			<aa:zone name="main">
				...
				<security:authorize ifAnyGranted="supplier-admit-remake-export">
				    <button  class='btn' onclick="iMatrix.export_Data('${actionBaseCtx}/export.htm?adminState=FDL&caName=Y');" type="button"><span><span><b class="btn-icons btn-icons-export"></b>导出</span></span></button>		
				</security:authorize> 
				...
				<%-- <security:authorize ifAnyGranted="supplier-add">					
					 <s:select list="systemCodes" 
								...
								listValue="name" 
								id="systemCode"
								onchange="systemCodeChange('material-admit/admit-remake/list-ok.htm')"
								cssStyle="width:60px"
								emptyOption="false"
								labelSeparator="">
					</s:select> 
				...
				<div id="opt-content">
					<form id="contentForm" method="post" action="" >
						<grid:jqGrid gridId="dynamicComplain" url="${actionBaseCtx}/list-datas.htm?caName=Y" code="SUPPLIER_SUPPLIER_ADMIT" pageName="page" ></grid:jqGrid>
					</form>
				</div>
			</aa:zone>
		</div>
