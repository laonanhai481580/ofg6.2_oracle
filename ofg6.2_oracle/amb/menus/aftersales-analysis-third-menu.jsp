...
<security:authorize ifAnyGranted="AFS_LAR_BAD_ITEM_LIST">
	<div id="lar_bad_item_rate" class="west-notree" ><a href="${aftersalesctx}/data-acquisition/lar-bad-item-rate.htm">LAR不良项目柏拉图</a></div>
</security:authorize>
...
<security:authorize ifAnyGranted="AFS_CUSTOMER_RETURN_RATE">
	<div id="customer_return" class="west-notree" ><a href="${aftersalesctx}/data-acquisition/customer-return-rate.htm">客退率趋势图</a></div>
</security:authorize>
