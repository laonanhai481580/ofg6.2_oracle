...
$(function() {
	...
	<script type="text/javascript" class="source">
		$(function () {
			...
			}else if(thirdMenu=="internalAuditor"){
				$("#internalAuditor").jstree({ 
					"html_data" : {
						"data" :  
							"<ul><li onclick='selectedNode(this)' id='internalAuditor'><a href='${gsmctx }/equipment/internal-auditor/list.htm'>内审员信息</a></li>"+
					         "</ul>"
					},
					"ui" : {
						"initially_select" : [ treeMenu ]
...
<div id="accordion1" class="basic">
	...
	<security:authorize ifAnyGranted="gsm_internal_auditor_list">
		<h3><a id="_internalAuditor" onclick="_change_menu('${gsmctx}/equipment/internal-auditor/list.htm');">内审员台账</a></h3>
		<div><div id="internalAuditor" class="demo">数据加载中......</div></div>
	</security:authorize>
