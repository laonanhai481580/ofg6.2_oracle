...
<security:authorize ifAnyGranted="gsm_nonconformity_input">
	<div id="nonconformityInput" class="west-notree" url="${gsmctx}/nonconformity/input.htm" onclick="changeMenu(this);"><span>校验不合格处理单</span></div>
</security:authorize> 
<security:authorize ifAnyGranted="gsm_nonconformity_list">
	<div id="nonconformityList" class="west-notree" url="${gsmctx}/nonconformity/list.htm" onclick="changeMenu(this);"><span>校验不合格处理单台帐</span></div>
</security:authorize> 
