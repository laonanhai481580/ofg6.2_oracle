...
<div class="fix-menu">
	<ul class="scroll-menu">
		...
		<security:authorize ifAnyGranted="gsm_nonconformity_list">
			<li id="nonconformity"><span><span><a href="${gsmctx }/nonconformity/list.htm">校验不合格处理</a></span></span></li>
		</security:authorize>
		<security:authorize ifAnyGranted="gsm_entrust_list,gsm_entrust_input1">
		...
		<security:authorize ifAnyGranted="gsm_base-inspectionbase1">
