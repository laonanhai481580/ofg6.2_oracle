...
<%-- 	<security:authorize ifAnyGranted="iqc-incominginspectionactionsreport-checked">
	...
	<security:authorize ifAnyGranted="iqc-exception-confirm-list">
		<div id="exception_confirm" class="west-notree" url="${iqcctx }/inspection-report/exception-confirm-list.htm" onclick="changeMenu(this);"><span>异常待确认台帐</span></div>
	</security:authorize>
<%--  	<security:authorize ifAnyGranted="iqc-wait-last-audit-list">
	...
	<security:authorize ifAnyGranted="iqc-inspection-report-oklist">
		<div id="myOkInspectionReport" class="west-notree" url="${iqcctx }/inspection-report/oklist.htm" onclick="changeMenu(this);"><span>检验合格台帐</span></div>
	</security:authorize>
	<security:authorize ifAnyGranted="iqc-inspection-report-unlist">
		<div id="myUnInspectionReport" class="west-notree" url="${iqcctx }/inspection-report/unlist.htm" onclick="changeMenu(this);"><span>检验不合格台帐</span></div>
	</security:authorize>
	<security:authorize ifAnyGranted="iqc-inspection-report-complete-list">
		<div id="completeInspectionReport" class="west-notree" url="${iqcctx }/inspection-report/complete.htm" onclick="changeMenu(this);"><span>检验完成台帐</span></div>
	</security:authorize>
 	...
 	<security:authorize ifAnyGranted="iqc-incominginspectionactionsreport-copy-list">
		<div id="copylist" class="west-notree" url="${iqcctx }/inspection-report/copy-list.htm" onclick="changeMenu(this);"><span>复制数据台帐</span></div>
	</security:authorize>	
	...
	<security:authorize ifAnyGranted="iqc_incomingInspectionActionsReport_recycle_list">
		<div id="inspection_recycle" class="west-notree" url="${iqcctx }/inspection-report/recycle-list.htm" onclick="changeMenu(this);"><span>已删除台帐</span></div>
	</security:authorize>
