				...
				$("#iqcsamplesheme").jstree({ 
					...
					"html_data" : {
						"data" : "<ul><li  class='jstree-closed' id='root'>GB/T2828"+
				          ...
				          "<ul>"+
				           <security:authorize ifAnyGranted="MIL-STD-1916">
				          "<li class='jstree-closed' id='root'>MIL-STD-1916"+
				          </security:authorize>
				          "<ul>"+
				          ...
				          "</li></ul>"+ 
				           ...
				           "<ul>"+
				           <security:authorize ifAnyGranted="ANSI ASQZ1.4">
				          "<li class='jstree-closed' id='root'>ANSI ASQCZ1.4-2003"+
				          </security:authorize>
				          "<ul>"+
				          <security:authorize ifAnyGranted="iqc-sample-standard-code-letter-tp-list">
				          	"<li onclick='selectedNode(this)' id='tp-code-letter'><a href='${iqcctx}/sample-standard/code-letter/tp-list.htm'>样本量字码表</a></li>"+
				          </security:authorize>
						  <security:authorize ifAnyGranted="iqc-sample-standard-ordinary-sample-tp-list">
					      	"<li onclick='selectedNode(this)' id='tp-ordinary-sample'><a href='${iqcctx}/sample-standard/ordinary-sample/tp-list.htm'>正常检验抽样方案</a></li>"+
					      </security:authorize>
					      <security:authorize ifAnyGranted="iqc-sample-standard-tighten-sample-tp-list">
					      	"<li onclick='selectedNode(this)' id='tp-tighten-sample'><a href='${iqcctx}/sample-standard/tighten-sample/tp-list.htm'>加严检验抽样方案</a></li>"+
					      </security:authorize>
					      <security:authorize ifAnyGranted="iqc-sample-standard-relax-sample-tp-list">
					      	"<li onclick='selectedNode(this)' id='tp-relax-sample'><a href='${iqcctx}/sample-standard/relax-sample/tp-list.htm'>放宽检验抽样方案</a></li>"+
					      </security:authorize>
				          "</ul>"+ 
				          "</li></ul>"+ 
				          
				          "<ul>"+
				           <security:authorize ifAnyGranted="MIL-STD-105E">
				          "<li class='jstree-closed' id='root'>MIL-STD-105E"+
				          </security:authorize>
				          "<ul>"+
				          <security:authorize ifAnyGranted="iqc-sample-standard-code-letter-mil-list">
				          	"<li onclick='selectedNode(this)' id='mil-code-letter'><a href='${iqcctx}/sample-standard/code-letter/mil-list.htm'>样本量字码表</a></li>"+
				          </security:authorize>
						  <security:authorize ifAnyGranted="iqc-sample-standard-ordinary-sample-mil-list">
					      	"<li onclick='selectedNode(this)' id='mil-ordinary-sample'><a href='${iqcctx}/sample-standard/ordinary-sample/mil-list.htm'>正常检验抽样方案</a></li>"+
					      </security:authorize>
					      <security:authorize ifAnyGranted="iqc-sample-standard-tighten-sample-mil-list">
					      	"<li onclick='selectedNode(this)' id='mil-tighten-sample'><a href='${iqcctx}/sample-standard/tighten-sample/mil-list.htm'>加严检验抽样方案</a></li>"+
					      </security:authorize>
					      <security:authorize ifAnyGranted="iqc-sample-standard-relax-sample-mil-list">
					      	"<li onclick='selectedNode(this)' id='mil-relax-sample'><a href='${iqcctx}/sample-standard/relax-sample/mil-list.htm'>放宽检验抽样方案</a></li>"+
					      </security:authorize>
				          "</ul>"+ 
				          "</li></ul>"+
				          
				          "<ul>"+
				           <security:authorize ifAnyGranted="C=0">
				          "<li class='jstree-closed' id='root'>零缺陷(C=0)抽样方案"+
				          </security:authorize>
					      "<ul>"+
