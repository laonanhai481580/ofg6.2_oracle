...
<ul>
	...
	<security:authorize ifAnyGranted="iqc-incominginspectionactionsreport-fpm-uncheck,iqc-wait-audit-fpm-list,iqc-inspection-report-complete-fpm-list,iqc-inspection-report-fpm-unlist,iqc-incominginspectionactionsreport-fpm-list">
		<li id="inspectionReport_fpm"><span><span><a href='<grid:authorize code="iqc-incominginspectionactionsreport-fpm-uncheck,iqc-wait-audit-fpm-list,iqc-inspection-report-complete-fpm-list,iqc-inspection-report-fpm-unlist,iqc-incominginspectionactionsreport-fpm-list" systemCode="iqc"></grid:authorize>'>检验报告</a></span></span></li>
	</security:authorize>	
