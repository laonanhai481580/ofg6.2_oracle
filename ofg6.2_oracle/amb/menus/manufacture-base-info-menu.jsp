...
<script type="text/javascript" class="source">
			$(function () {
				...
				if(thirdMenu=="bom"){
					...
					aId = "_defectionCode";
				}else if(thirdMenu=="factoryProcedure"){
					$("#factoryProcedure").jstree({ 
						"html_data" : {
							"data" :
					          "<ul>"+<security:authorize ifAnyGranted="carmfg-oqc-factory-list">
					          	"<li onclick='selectedNode(this)' id='_factory'><a href='${mfgctx}/base-info/factory-procedure/factory-list.htm'>工厂维护</a></li>"
					          	+</security:authorize>
						      "</ul>"
						},
						"ui" : {
						...
						"html_data" : {
							"data" :
					          "<ul>"+<security:authorize ifAnyGranted="carmfg-ipqc-warming-list">
					          	"<li onclick='selectedNode(this)' id='_ipqc_warming'><a href='${mfgctx}/ipqc/ipqc-warming/list.htm'>IPQC稽核预警维护</a></li>"
					          	+"<li onclick='selectedNode(this)' id='_problem_score'><a href='${mfgctx}/ipqc/problem-score/list.htm'>IPQC问题严重度分数维护</a></li>"
					          	+</security:authorize>
						      "</ul>"
						},
						"ui" : {
					...
					aId = "_ipqc_warming";
				}else if(thirdMenu=="audit_amount"){
					$("#audit_amount").jstree({ 
						"html_data" : {
							"data" :
					          "<ul>"+<security:authorize ifAnyGranted="carmfg-ipqc-auditAmount-list">
					          	"<li onclick='selectedNode(this)' id='_audit_amount'><a href='${mfgctx}/ipqc/audit-amount/list.htm'>IPQC稽核件数维护</a></li>"
					          	+</security:authorize>
						      "</ul>"
						},
						"ui" : {
...
// 				}
	...
	<div id="accordion1" class="basic">
		...
		<security:authorize ifAnyGranted="carmfg-ipqc-auditAmount-list">
		<h3><a id="_audit_amount" onclick="_change_menu('<grid:authorize code="carmfg-ipqc-auditAmount-list" systemCode="carmfg"></grid:authorize>');">IPQC稽核件数维护</a></h3>
		<div>
			<div id="audit_amount" class="demo">菜单加载中,请稍候...</div>
		</div>
		</security:authorize>		
		...
		<security:authorize ifAnyGranted="carmfg-oqc-factory-list,carmfg-oqc-procedure-list">
		<h3><a id="_factoryProcedure" onclick="_change_menu('<grid:authorize code="carmfg-oqc-factory-list,carmfg-oqc-procedure-list" systemCode="carmfg"></grid:authorize>');">工厂工序维护</a></h3>
		<div>
			<div id="factoryProcedure" class="demo">菜单加载中,请稍候...</div>
		</div>
		</security:authorize>		
