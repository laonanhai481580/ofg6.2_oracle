...
<%@ include file="/common/taglibs.jsp"%>
    <div style="display: block; height: 10px;"></div>
	 ...
	 <security:authorize ifAnyGranted="MFG_IPQC_SAMPLING_BAD_LIST">
		<div id="_ipqc_sampling_bad" class="west-notree" url="${mfgctx}/data-acquisition/analyse/ipqc-sampling-bad.htm" onclick="changeMenu(this);"><span>制程检验不良项目柏拉图</span></div>
	 </security:authorize>	
	 <security:authorize ifAnyGranted="MFG_IPQC_BATCH_PASS_LIST">	
		<div id="_ipqc_batch_pass_rate" class="west-notree" url="${mfgctx}/data-acquisition/analyse/ipqc-batch-pass-rate.htm" onclick="changeMenu(this);"><span>制程检验批次合格率推移图</span></div>
	 </security:authorize>	
	 ...
	 <security:authorize ifAnyGranted="MFG_OQC_EXCEPTION_RATE">	
		<div id="oqc_exception" class="west-notree" url="${mfgctx}/data-acquisition/analyse/oqc-exception-rate.htm" onclick="changeMenu(this);"><span>OQC异常柏拉图</span></div>
	 </security:authorize>
	 <%-- <security:authorize ifAnyGranted="MFG_IPQC_OBSERVE_LIST">	
		<div id="_ipqc_observe" class="west-notree" url="${mfgctx}/data-acquisition/analyse/observe-rate.htm" onclick="changeMenu(this);"><span>IPQC遵守度统计图</span></div>
	 </security:authorize> --%>
	 	<security:authorize ifAnyGranted="MFG_OQC_ITEM_RATE">	
		<div id="_oqc_bad_trend" class="west-notree" url="${mfgctx}/data-acquisition/analyse/oqc-item-trend.htm" onclick="changeMenu(this);"><span>OQC不良项目推移图</span></div>
	 </security:authorize>			 
