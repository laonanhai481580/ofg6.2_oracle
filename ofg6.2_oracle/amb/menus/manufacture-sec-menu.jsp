...
<ul>
	...
	<security:authorize ifAnyGranted="mfg_patrol_list,mfg_patrol">
		<li  id="patrol">
			<span><span>
				<a href='<grid:authorize code="mfg_patrol_list,mfg_patrol" systemCode="carmfg"></grid:authorize>'>巡检报告</a>
			</span></span>
		</li>
	</security:authorize>
...
<%-- 	<security:authorize ifAnyGranted="MFG_ORT_PLAN_LIST">
	...
	<security:authorize ifAnyGranted="MFG_OQC_INSPECTION_LIST,MFG_OQC_DELIVER_LIST">
		<li  id="oqc_list">
			<span><span>
				<a href='<grid:authorize code="MFG_OQC_INSPECTION_LIST,MFG_OQC_DELIVER_LIST" systemCode="carmfg"></grid:authorize>'>OQC检验管理</a>
			</span></span>
		</li>
	</security:authorize>	
