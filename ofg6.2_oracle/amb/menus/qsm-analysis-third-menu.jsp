...
<security:authorize ifAnyGranted="QSM_AUDIT_BING_LIST">
	<div id="audt_bing_rate" class="west-notree" ><a href="${qsmctx}/data-acquisition/audit-bing-rate.htm">客户审核改善报告柏拉图</a></div>
</security:authorize>
...
<security:authorize ifAnyGranted="QSM_INNER_AUDIT_CLOSE_LIST">
	<div id="inner_audt_close_rate" class="west-notree" ><a href="${qsmctx}/data-acquisition/inner-audit-close-rate.htm">不符合纠正措施结案率推移图</a></div>
</security:authorize>
