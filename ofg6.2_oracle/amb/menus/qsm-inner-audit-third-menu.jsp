...
<%@ include file="/common/taglibs.jsp"%>
	...
	<security:authorize ifAnyGranted="QSM_PROBLEMS_INPUT1">
		<div id="_problems_input" class="west-notree"  ><a href="${qsmctx}/inner-audit/problems/input.htm">内审问题点改善报告</a></div>
	</security:authorize>
	<security:authorize ifAnyGranted="QSM_PROBLEMS_LIST1">
		<div id="_problems_list" class="west-notree"  ><a href="${qsmctx}/inner-audit/problems/list.htm">内审问题点改善台账</a></div>
	</security:authorize>
	<security:authorize ifAnyGranted="QSM_CORRECT_MEASURES_INPUT">
		<div id="_correct_measures_input" class="west-notree"  ><a href="${qsmctx}/inner-audit/correct-measures/input.htm">不符合与纠正措施报告</a></div>
	</security:authorize>
	<security:authorize ifAnyGranted="QSM_CORRECT_MEASURES_LIST">
		<div id="_correct_measures_list" class="west-notree"  ><a href="${qsmctx}/inner-audit/correct-measures/list.htm">不符合项跟踪台账</a></div>
	</security:authorize>
