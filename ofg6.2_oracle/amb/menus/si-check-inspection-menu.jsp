...
<div style="display: block; height: 10px;"></div>
	...
	<security:authorize ifAnyGranted="si-report-list-hide">
		<div id="_si_list_hide" class="west-notree" url="${sictx}/check-inspection/hide-list.htm" onclick="changeMenu(this);"><span>SI报告敏感数据台帐</span></div>
	</security:authorize>
