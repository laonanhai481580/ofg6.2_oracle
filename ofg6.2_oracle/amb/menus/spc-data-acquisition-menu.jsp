...
<%-- <security:authorize ifAnyGranted="spc_data-acquisition_special-excel-spc-import">
	<div id="_special-excel-spc-import" class="west-notree" url="${spcctx}/data-acquisition/special-excel-spc-import.htm" onclick="changeMenu(this);"><span>EXCEL模板离线采集</span></div>
</security:authorize> --%>
<%-- <security:authorize ifAnyGranted="spc_data-acquisition_list">
...
<%-- </security:authorize> --%>
<security:authorize ifAnyGranted="spc_data-acquisition_data-list">
	<div id="_maintenance_data" class="west-notree" url="${spcctx}/data-acquisition/data-list.htm" onclick="changeMenu(this);"><span>数据维护</span></div>
</security:authorize>
<%-- <security:authorize ifAnyGranted="spc_data-acquisition_list">
