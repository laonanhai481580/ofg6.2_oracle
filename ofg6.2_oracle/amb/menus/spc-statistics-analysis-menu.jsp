...
<security:authorize ifAnyGranted="spc_statistics-analysis_spc-ppk">
	<div id="_spc_ppk" class="west-notree" url="${spcctx }/statistics-analysis/spc-ppk.htm" onclick="changeMenu(this);"><span>PPK统计报表</span></div>
</security:authorize>
