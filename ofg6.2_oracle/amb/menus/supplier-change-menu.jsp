...
<security:authorize ifAnyGranted="supplier-change-list-all">
	<div id="changelistAll" class="west-notree" url="${supplierctx }/change/list-all.htm"
		onclick="changeMenu(this);">
		<span>PCN 申请汇总台账</span>
	</div>
</security:authorize>
