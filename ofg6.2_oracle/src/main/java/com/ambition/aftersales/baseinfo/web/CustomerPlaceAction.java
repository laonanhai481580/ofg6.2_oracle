...
public class CustomerPlaceAction extends BaseAction<CustomerPlace>{
	...
	protected void prepareModel() throws Exception {
		if(id == null){
			...
			customerPlace.setBusinessUnitCode(CommonUtil.getBusinessUnitCode(ContextUtils.getCompanyName()));
		}else{
	...
	public String delete() throws Exception {
		String deleteNos=customerPlaceManager.deleteCustomerPlace(deleteIds);
		//日志消息,方便跟踪删除记录
		Struts2Utils.getRequest().setAttribute(LogInfo.MESSAGE_ATTRIBUTE,"删除客户清单台帐,客户场地名称为【" + deleteNos + "】!");
		return null;
	}
