...
public class FormCodeGenerated extends HibernateDao<Object, Long>{
	...
	/**
	  ...
	  * @return
	 */
	public String generatePatrolCode() {
		return formCodeRuleManager.generatedCodeByCode(FormCodingRule.CODE_PR);
	}
	/**
	  * 方法名:ORT实验委托单编号
	  * <p>功能说明：</p>
	...
	public String getExceptionContactCode() {
		// TODO Auto-generated method stub
		return formCodeRuleManager.generatedCodeByCode(FormCodingRule.CODE_EXCEPTION_CONTACT);
	}
	public String getExceptionImproveCode() {
		// TODO Auto-generated method stub
		return formCodeRuleManager.generatedCodeByCode(FormCodingRule.CODE_EXCEPTION_IMPROVE);
	}
