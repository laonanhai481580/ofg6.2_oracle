...
public class DefectionTypeManager {
	...
	//验证并保存记录
	public boolean isExistDefectionType(Long id, String no, String name,String businessUnit,String productType){
	...
	public void saveDefectionType(DefectionType defectionType){
		...
		if(isExistDefectionType(defectionType.getId(), defectionType.getDefectionTypeNo(), defectionType.getDefectionTypeName(),defectionType.getBusinessUnitName(),defectionType.getProductType())){
			throw new RuntimeException(defectionType.getBusinessUnitName()+"的"+defectionType.getProductType()+"类别下已存在相同不良类别代码或名称!");
		}
	...
	public List<DefectionType> getDefectionTypeByBusinessUnit(String businessUnit,String productType){
		return defectionTypeDao.getDefectionTypeByBusinessUnit(businessUnit,productType);
	}
	public String listDefectionTypeNoByName(String name,String businessUnit,String productType){
		return defectionTypeDao.getDefectionTypeNoByName(name,businessUnit,productType);
	}	
