...
public class DefectionCodeAction extends BaseAction<DefectionCode>{
	...
	protected void prepareModel() throws Exception {
		if(id == null){
			...
			defectionCode.setBusinessUnitCode(CommonUtil.getBusinessUnitCode(ContextUtils.getCompanyName()));
		}else{
	...
	public String delete() throws Exception {
		String str=defectionCodeManager.deleteDefectionCode(deleteIds);
		Struts2Utils.getRequest().setAttribute(LogInfo.MESSAGE_ATTRIBUTE,"删除不良,名称为:"+str);
		return null;
	}
	...
	public String deleteSubs() throws Exception {
		...
		Struts2Utils.getRequest().setAttribute(LogInfo.MESSAGE_ATTRIBUTE,"删除不良类别："+defectionCode.getDefectionType().getDefectionTypeName()+"下所有工序");
		return null;
	}
