 ...
 */
@Entity
@Table(name = "MFG_IPQC_AUDIT_IMPROVE")
...
public class IpqcAuditImprove  extends WorkflowIdEntity{
	...
	private String worker;//作业员
	private String operator;//稽核员
	private String operatorLogin;//稽核员登录名
	...
	private String auditMan;//稽核人员
	
	private String reasonAnalysis;//原因分析
	private String isDuice;//是否经过对策分析人
	private String reasontMan;//原因责任人
	private String reasontManLogin;//原因责任人登录名
	private Date reasontDate;//原因责任单位填写时间
	private String improveMeasures;//改善对策
	private String improveFile;//改善对策附件
	private String departmentMan;//责任单位填写人
	private String departmentManLogin;//责任单位填写人登录名
	...
	public String getReasontMan() {
		return reasontMan;
	}
	public void setReasontMan(String reasontMan) {
		this.reasontMan = reasontMan;
	}
	public String getReasontManLogin() {
		return reasontManLogin;
	}
	public void setReasontManLogin(String reasontManLogin) {
		this.reasontManLogin = reasontManLogin;
	}
	public Date getReasontDate() {
		return reasontDate;
	}
	public void setReasontDate(Date reasontDate) {
		this.reasontDate = reasontDate;
	}
	public String getIsDuice() {
		return isDuice;
	}
	public void setIsDuice(String isDuice) {
		this.isDuice = isDuice;
	}
