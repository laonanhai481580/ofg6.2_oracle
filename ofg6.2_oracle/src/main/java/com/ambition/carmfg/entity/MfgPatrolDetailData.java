 ...
 */
@Entity
@Table(name="MFG_PATROL_DATAIL_DATA")
public class MfgPatrolDetailData extends IdEntity{
	...
	@ManyToOne
	@JoinColumn(name="FK_MFG_PATROL_DATAIL_ID")
	private MfgPatrolDetail mfgPatrolDetail;//检验报告
	...
	public MfgPatrolDetail getMfgPatrolDetail() {
		return mfgPatrolDetail;
	}

	public void setMfgPatrolDetail(MfgPatrolDetail mfgPatrolDetail) {
		this.mfgPatrolDetail = mfgPatrolDetail;
	}
