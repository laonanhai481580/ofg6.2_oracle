 ...
 */
@Entity
@Table(name = "MFG_PATROL_REPORT")
public class MfgPatrolReport extends IdEntity implements FormFlowable {
	...
	private String produceMachine;//生产机台
	...
	@OneToMany(mappedBy="mfgPatrolReport",cascade=CascadeType.ALL)
	@Cascade(org.hibernate.annotations.CascadeType.DELETE_ORPHAN)
	@JsonIgnore
	private List<MfgPatrolDetail> checkItems;//检查项目
	...
	public String getProduceMachine() {
		return produceMachine;
	}

	public void setProduceMachine(String produceMachine) {
	...
	public List<MfgPatrolDetail> getCheckItems() {
		return checkItems;
	}

	public void setCheckItems(List<MfgPatrolDetail> checkItems) {
