...
public class OqcInspection extends IdEntity{
	...
	private Integer stockBatch;//投入批
	private Integer qualityBatch;//合格批
	private String qualityBatchRate;//批合格率
	...
	public Integer getStockBatch() {
		return stockBatch;
	}
	public void setStockBatch(Integer stockBatch) {
		this.stockBatch = stockBatch;
	}
	public Integer getQualityBatch() {
		return qualityBatch;
	}
	public void setQualityBatch(Integer qualityBatch) {
		this.qualityBatch = qualityBatch;
	}
	public String getQualityBatchRate() {
		return qualityBatchRate;
	}
	public void setQualityBatchRate(String qualityBatchRate) {
		this.qualityBatchRate = qualityBatchRate;
	}
