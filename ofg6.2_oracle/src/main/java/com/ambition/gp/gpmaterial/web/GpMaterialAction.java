...
//		CommonUtil.setProperty(report);
		String gpMaterial=gpMaterialManager.getGpMaterial(report.getSupplierCode(),report.getMaterialCode(),report.getId());
		if("true".equals(gpMaterial)){
...
//			addActionMessage("该供应商已有此物料编码!");
	...
	public String submitProcess() {
		...
		try{
			...
			if("该供应商已有此物料编码!".equals(e.getMessage())){
