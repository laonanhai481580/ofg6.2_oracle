...
@JsonIgnoreProperties(value={"hibernateLazyInitializer","handler","fieldHandler"})//作用于:json转换异常
public class GsmEquipment extends IdEntity {
	...
	public static final String STATE_LOSE="遗失";
	public static final String STATE_CHECKUP="校验中";
	...
	private String businessUnits;//厂区
	private String factory;//工厂
	private Date stockPlanTime;//盘点计划时间
	private String stockPlanPerson;//盘点计划人
	private Date stockActualTime;//盘点实际时间
	private String stockActualPerson;//盘点实际人
	private String stockState="P";//盘点状态
	...
	public String getStockPlanPerson() {
		return stockPlanPerson;
	}
	public void setStockPlanPerson(String stockPlanPerson) {
		this.stockPlanPerson = stockPlanPerson;
	}
	...
	public String getStockActualPerson() {
		return stockActualPerson;
	}
	public void setStockActualPerson(String stockActualPerson) {
		this.stockActualPerson = stockActualPerson;
	}
	public Date getStockPlanTime() {
		return stockPlanTime;
	}
	public void setStockPlanTime(Date stockPlanTime) {
		this.stockPlanTime = stockPlanTime;
	}
	public Date getStockActualTime() {
		return stockActualTime;
	}
	public void setStockActualTime(Date stockActualTime) {
		this.stockActualTime = stockActualTime;
	}
