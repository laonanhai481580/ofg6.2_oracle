...
public class InspectionPlan extends IdEntity implements Cloneable{
	...
	private String innerReportNo;//內校报告编号
	private String innerReportId;//內校报告ID
...
//	@Cascade(org.hibernate.annotations.CascadeType.DELETE_ORPHAN)
	...
	public String getInnerReportNo() {
		return innerReportNo;
	}
	public void setInnerReportNo(String innerReportNo) {
		this.innerReportNo = innerReportNo;
	}
	public String getInnerReportId() {
		return innerReportId;
	}
	public void setInnerReportId(String innerReportId) {
		this.innerReportId = innerReportId;
	}
