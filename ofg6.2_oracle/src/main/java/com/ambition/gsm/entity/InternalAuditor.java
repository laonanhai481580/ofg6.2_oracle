 ...
 */
@Entity
@Table(name = "GSM_INTERNAL_AUDITOR")
@JsonIgnoreProperties(value={"hibernateLazyInitializer","handler","fieldHandler"})
public class InternalAuditor extends IdEntity{
	...
	private Date attackTime;//工作开始时间，入司时间
	private String workAge;//工作年限
	private Date auditDate;//审核开始时间
	private Integer auditAge;//审核年限
	...
	private String hasCertificate;//是否取得证书证书
	private String validDate;//证书有效期
	...
	public Integer getAuditAge() {
		return auditAge;
	}
	public void setAuditAge(Integer auditAge) {
		this.auditAge = auditAge;
	}
