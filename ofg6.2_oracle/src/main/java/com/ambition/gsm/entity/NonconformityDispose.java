...
public class NonconformityDispose extends WorkflowIdEntity{
	...
	private String userPeopleOpinion;//使用人登入名
	...
	private String anewRetest;//是否需要重新检测
	...
	public String getUserPeopleOpinion() {
		return userPeopleOpinion;
	}
	public void setUserPeopleOpinion(String userPeopleOpinion) {
		this.userPeopleOpinion = userPeopleOpinion;
	}
	public String getAnewRetest() {
		return anewRetest;
	}
	public void setAnewRetest(String anewRetest) {
		this.anewRetest = anewRetest;
	}
