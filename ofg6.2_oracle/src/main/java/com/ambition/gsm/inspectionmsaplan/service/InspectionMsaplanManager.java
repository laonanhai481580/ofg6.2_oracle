...
//				gsmEquipment.setGenerateMsaState(null);
	...
	public Page<InspectionMsaplan> listState(Page<InspectionMsaplan> page,String state ,String str){
		String hql = " from InspectionMsaplan e where e.gsmState=? and e.companyId";
		...
		return inspectionMsaplanDao.searchPageByHql(page, hql, searchParams.toArray());
	}
}
