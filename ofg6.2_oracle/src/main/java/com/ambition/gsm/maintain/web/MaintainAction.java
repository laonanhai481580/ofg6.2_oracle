...
public class MaintainAction extends CrudActionSupport<Maintain>{
	...
	public void setIds(String ids) {
		...
		@Action("delete")
		@LogInfo(optType="删除",message="删除维修管理数据")
		@Override
...
//				System.out.println(renderText(PageUtils.pageToJson(page)));
		...
		protected void prepareModel() throws Exception {
			...
			if(id == null){
				...
				maintain.setBusinessUnitCode(CommonUtil.getBusinessUnitCode(ContextUtils.getCompanyName()));
			}else {
		...
		@Action("save")
		@LogInfo(optType="保存",message="保存维修管理数据")
		@Override
