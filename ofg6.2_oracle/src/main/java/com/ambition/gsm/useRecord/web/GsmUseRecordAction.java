...
public class GsmUseRecordAction extends CrudActionSupport<GsmUseRecord> {
	...
	protected void prepareModel() throws Exception {
		if(id == null){
			...
			gsmUseRecord.setBusinessUnitCode(CommonUtil.getBusinessUnitCode(ContextUtils.getCompanyName()));
		}else {
	...
	public String getReturnDatas() throws Exception {
		try {
			...
			if(useDept != null){
				gsmPage = gsmEquipmentManager.getPageByUseDept(gsmPage, useDept,processSection);
			}
