...
import com.ambition.util.erp.service.SupplierAbnormalTotalService;
import com.ambition.util.erp.service.SupplierAdmitTotalService;
import com.ambition.util.erp.service.SupplierAuditTotalService;
import com.ambition.util.erp.service.SupplierChangeTotalService;
import com.ambition.util.erp.service.SupplierEmailIntegrationService;
import com.ambition.util.erp.service.SupplierFileService;
import com.ambition.util.erp.service.SupplierImproveTotalService;
...
import com.ambition.util.erp.service.SupplierMessageService;
import com.ambition.util.erp.service.SupplierRecordService;
import com.ambition.util.erp.service.SupplierTotalService;
import com.ambition.util.erp.service.SupplierYearInspectService;
import com.ambition.util.erp.service.UpdateFailTaskIntegrationService;
...
public class QisAndErpUpdateAction extends CrudActionSupport<UpdateTimestamp>{
	...
	@Autowired
	private SupplierYearInspectService supplierYearInspectService;
	@Autowired
	...
	@Autowired
	private SupplierImproveTotalService supplierImproveTotalService;
	@Autowired
	private SupplierAuditTotalService supplierAuditTotalService;
	@Autowired
	private SupplierChangeTotalService supplierChangeTotalService;
	@Autowired
	private SupplierAbnormalTotalService supplierAbnormalTotalService;
	@Autowired
	private SupplierAdmitTotalService supplierAdmitTotalService;
	@Autowired
	private SupplierMessageService supplierMessageService;
	@Autowired
	private SupplierFileService supplierFileService;
	@Autowired
	private UpdateFailTaskIntegrationService updateFailTaskIntegrationService;
	@Autowired
	private SupplierTotalService supplierTotalService;
   ...
   public String inspectionReport() throws Exception {
	...
	/**
	  ...
	  /**
	    ...
	    * @throws Exception
	   */
	  @Action("import-supplier-year-inspect")
	  public String supplierYearInspect() throws Exception {
	      try {
	    	  supplierYearInspectService.beginIntegration(ContextUtils.getCompanyId(),ContextUtils.getLoginName());
	          createMessage("供应商稽核提醒信息更新成功!");
	      } catch (Exception e) {
	          log.error("供应商稽核提醒信息更新失败!",e);
	          createErrorMessage("供应商稽核提醒信息更新失败:" + e.getMessage());
	      }
	      return null;
	  }
	  /**
	  ...
	  /**
	    ...
	    * @throws Exception
	   */
	  @Action("import-supplier-record")
	  public String supplierRecord() throws Exception {
	      try {
	    	  supplierRecordService.beginIntegration(ContextUtils.getCompanyId(),ContextUtils.getLoginName());
	          createMessage("供应商名录OR集成更新成功!");
	      } catch (Exception e) {
	          log.error("供应商名录OR集成更新更新失败!",e);
	          createErrorMessage("供应商名录OR集成更新失败:" + e.getMessage());
	      }
	      return null;
	  }
	  ...
	  /**
	    ...
	    * @throws Exception
	   */
	  @Action("import-supplier-improve")
	  public String supplierImprove() throws Exception {
	      try {
	    	  supplierAdmitTotalService.beginIntegration(ContextUtils.getCompanyId(),ContextUtils.getLoginName());
	          createMessage("供应商改进集成更新成功!");
	      } catch (Exception e) {
	          log.error("供应商改进集成更新更新失败!",e);
	          createErrorMessage("供应商改进集成更新失败:" + e.getMessage());
	      }
	      return null;
	  }	  
	  /**
	    ...
	    * @throws Exception
	   */
	  @Action("import-ipqc-auto")
	  public String ipqcAuto() throws Exception {
	      try {
	    	  ipqcAutoSubmitIntegrationService.beginIntegration(ContextUtils.getCompanyId(),ContextUtils.getLoginName());
	          createMessage("IPQC自动提交更新成功!");
	      } catch (Exception e) {
	          log.error("IPQC自动提交更新失败!",e);
	          createErrorMessage("IPQC自动提交更新失败:" + e.getMessage());
	      }
	      return null;
	  }	
	/**
