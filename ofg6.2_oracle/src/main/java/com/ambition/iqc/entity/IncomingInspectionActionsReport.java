...
public class IncomingInspectionActionsReport extends IdEntity implements FormFlowable {
	...
	private String checkBomNameIn;//物料名称
	private String checkBomNameOut;//物料名称
	...
	private String supplierNameTrue; //原厂供应商
	private String supplierCodeTrue;//原厂供方编码
	private String supplierNameOut; //对外供应商名称
	private String supplierCodeOut;//对外供应商编码
	private String supplierNameIn; //对内供应商名称
	private String supplierCodeIn;//对内供应商供方编码
	...
	private String  wgInspector;//外观检验员
	private String  sizeInspector;//尺寸检验员
	private String qualifiedInspector;//特性检验员
	...
	private String isFactory="否";//是否驻厂检验
	...
	@Cascade(org.hibernate.annotations.CascadeType.DELETE_ORPHAN)
	@JsonIgnore()
	private List<CheckItem1> checkItems1;//检查项目
	@OneToMany(mappedBy="iiar",cascade=CascadeType.ALL)
	@Cascade(org.hibernate.annotations.CascadeType.DELETE_ORPHAN)
	@JsonIgnore()
	private List<CheckItem2> checkItems2;//检查项目
	...
	private String ordReportNo1;//报告编号
	private String ordReportId1;//报告ID
	private String ordReportNo3;//报告编号
	private String ordReportId3;//报告ID
	private String ordTextSpecial;//
	@Column(length=3000)
	...
	private Integer preMail;//上次发邮件间隔时间
	...
	public void setInspectionDate(Date inspectionDate) {
		...
		if(inspectionDate == null){
			...
			this.setYearAndMonth(CommonUtil.getYearAndMonth(inspectionDate));
			this.setYearAndWeek(CommonUtil.getYearAndWeek(inspectionDate));
			this.setDateOfMonthOfYear(CommonUtil.getYearMonthAndDate(inspectionDate));
		}
	}
	...
	public void setEnterDate(Date enterDate) {
		...
		if(enterDate == null){
			...
			this.enterYearMonthAndDate = CommonUtil.getYearMonthAndDate(enterDate);;
		}
	}
	...
	public List<CheckItem1> getCheckItems1() {
		return checkItems1;
	}


	public void setCheckItems1(List<CheckItem1> checkItems1) {
		this.checkItems1 = checkItems1;
	}


	public List<CheckItem2> getCheckItems2() {
		return checkItems2;
	}


	public void setCheckItems2(List<CheckItem2> checkItems2) {
		this.checkItems2 = checkItems2;
	}
	...
	public String getInputManLogin() {
		return inputManLogin;
	}


	public void setInputManLogin(String inputManLogin) {
		this.inputManLogin = inputManLogin;
	}
	...
	public String getWgInspector() {
		return wgInspector;
	}


	public void setWgInspector(String wgInspector) {
		this.wgInspector = wgInspector;
	}


	public String getSizeInspector() {
		return sizeInspector;
	}


	public void setSizeInspector(String sizeInspector) {
		this.sizeInspector = sizeInspector;
	}


	public String getQualifiedInspector() {
		return qualifiedInspector;
	}


	public void setQualifiedInspector(String qualifiedInspector) {
		this.qualifiedInspector = qualifiedInspector;
	}


	public String getCheckBomNameIn() {
		return checkBomNameIn;
	}


	public void setCheckBomNameIn(String checkBomNameIn) {
		this.checkBomNameIn = checkBomNameIn;
	}


	public String getCheckBomNameOut() {
		return checkBomNameOut;
	}


	public void setCheckBomNameOut(String checkBomNameOut) {
		this.checkBomNameOut = checkBomNameOut;
	}
	...
	public Integer getPreMail() {
		return preMail;
	}


	public void setPreMail(Integer preMail) {
		this.preMail = preMail;
	}


	public String getOrdReportNo1() {
		return ordReportNo1;
	}


	public void setOrdReportNo1(String ordReportNo1) {
		this.ordReportNo1 = ordReportNo1;
	}


	public String getOrdReportId1() {
		return ordReportId1;
	}


	public void setOrdReportId1(String ordReportId1) {
		this.ordReportId1 = ordReportId1;
	}


	public String getOrdReportNo3() {
		return ordReportNo3;
	}


	public void setOrdReportNo3(String ordReportNo3) {
		this.ordReportNo3 = ordReportNo3;
	}


	public String getOrdReportId3() {
		return ordReportId3;
	}


	public void setOrdReportId3(String ordReportId3) {
		this.ordReportId3 = ordReportId3;
	}


	public String getOrdTextSpecial() {
		return ordTextSpecial;
	}


	public void setOrdTextSpecial(String ordTextSpecial) {
		this.ordTextSpecial = ordTextSpecial;
	}
	...
	public String getSupplierNameTrue() {
		return supplierNameTrue;
	}


	public void setSupplierNameTrue(String supplierNameTrue) {
		this.supplierNameTrue = supplierNameTrue;
	}


	public String getSupplierCodeTrue() {
		return supplierCodeTrue;
	}


	public void setSupplierCodeTrue(String supplierCodeTrue) {
		this.supplierCodeTrue = supplierCodeTrue;
	}
