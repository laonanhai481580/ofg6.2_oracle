...
public class IncomingInspectionActionsReportDao extends HibernateDao<IncomingInspectionActionsReport, Long> {
	...
	public Page<IncomingInspectionActionsReport> list(Page<IncomingInspectionActionsReport> page,String checkItem){		
		  String hql = "from IncomingInspectionActionsReport o where o.inspectionState != ? and o.hiddenState = 'N' and o.isDelete = '否' ";
		  String businessUnitName = CommonUtil.getDataByLogin();
		  if(businessUnitName!=null&&!acsUtils.isAuthority("iqc_all", ContextUtils.getUserId(), ContextUtils.getCompanyId())){
			  hql += " and o.processSection='"+businessUnitName+"' ";
		  }
		  if(checkItem!=null){
...
//		return  searchPageByHql(page, hql,DateUtil.parseDate(startStr),DateUtil.parseDate(endStr),ContextUtils.getCompanyId(),IncomingInspectionActionsReport.INPECTION_STATE_AUDIT,"%免检%",DateUtil.parseDate(startStr));
	...
	public Page<IncomingInspectionActionsReport> listUnCheck(Page<IncomingInspectionActionsReport> page,String checkItem){
		  String hql = "from IncomingInspectionActionsReport o where o.hiddenState= 'N' and o.isDelete='否' and o.inspectionState in ('" + IncomingInspectionActionsReport.INPECTION_STATE_DEFAULT + "','"+IncomingInspectionActionsReport.INPECTION_STATE_RE_CHECK+"','"+IncomingInspectionActionsReport.INPECTION_STATE_SAVE_TEMP+"')";
		  String businessUnitName = CommonUtil.getDataByLogin();
		  if(businessUnitName!=null&&!acsUtils.isAuthority("iqc_all", ContextUtils.getUserId(), ContextUtils.getCompanyId())){
			  hql += " and (o.processSection='"+businessUnitName+"' or o.processSection='公用' or o.processSection is null) ";
		  }
		  if(checkItem!=null){
			  hql += " and o.checkItems==null";
		  }
	...
	public Page<IncomingInspectionActionsReport> listReCheck(Page<IncomingInspectionActionsReport> page,String checkItem){
		  String hql = "from IncomingInspectionActionsReport o where o.hiddenState = 'N' and o.isDelete='否' and o.inspectionState in ('"
	...
	public Page<IncomingInspectionActionsReport> listChecked(Page<IncomingInspectionActionsReport> page,String checkItem){
		  String hql = "from IncomingInspectionActionsReport o where o.isDelete='否' and o.hiddenState = 'N' and o.inspectionState in ('" + IncomingInspectionActionsReport.INPECTION_STATE_AUDIT + "','"
	...
	public Page<IncomingInspectionActionsReport> listWaitAudit(Page<IncomingInspectionActionsReport> page,String checkItem){
		  String hql = "from IncomingInspectionActionsReport o where o.hiddenState = 'N' and o.isDelete='否' and o.inspectionState = ?  ";
		  String businessUnitName = CommonUtil.getDataByLogin();
		  if(businessUnitName!=null&&!acsUtils.isAuthority("iqc_all", ContextUtils.getUserId(), ContextUtils.getCompanyId())){
			  hql += " and o.processSection='"+businessUnitName+"' ";
		  }
	...
	public Page<IncomingInspectionActionsReport> listAudit(Page<IncomingInspectionActionsReport> page,String checkItem){
		  String hql = "from IncomingInspectionActionsReport o where o.hiddenState = 'N' and o.isDelete='否' and( o.inspectionState = ? or o.inspectionState = ?) ";
		  String businessUnitName = CommonUtil.getDataByLogin();
		  if(businessUnitName!=null&&!acsUtils.isAuthority("iqc_all", ContextUtils.getUserId(), ContextUtils.getCompanyId())){
			  hql += " and o.processSection='"+businessUnitName+"' ";
		  }
		  ...
		  return searchPageByHql(page, hql,IncomingInspectionActionsReport.INPECTION_STATE_LAST_SUBMIT,IncomingInspectionActionsReport.INPECTION_STATE_SUBMIT);
	}
	public Page<IncomingInspectionActionsReport> listAuditSingle(Page<IncomingInspectionActionsReport> page,String checkItem){
		  String hql = "from IncomingInspectionActionsReport o where o.hiddenState = 'N' and o.isDelete='否' and( o.inspectionState = ? or o.inspectionState = ?) ";
		  String businessUnitName = CommonUtil.getDataByLogin();
		  if(businessUnitName!=null&&!acsUtils.isAuthority("iqc_all", ContextUtils.getUserId(), ContextUtils.getCompanyId())){
			  hql += " and o.processSection='"+businessUnitName+"' ";
		  ...
		  hql+=" and o.currentAuditManLogin=? ";
		  return searchPageByHql(page, hql,IncomingInspectionActionsReport.INPECTION_STATE_LAST_SUBMIT,IncomingInspectionActionsReport.INPECTION_STATE_SUBMIT,login);
	}
	public Page<IncomingInspectionActionsReport> listAuditSingleFpm(Page<IncomingInspectionActionsReport> page,String checkItem){
		  String hql = "from IncomingInspectionActionsReport o where o.hiddenState = 'N' and o.isDelete='否' and( o.inspectionState = ? or o.inspectionState = ?) ";
		  String businessUnitName = CommonUtil.getDataByLogin();
		  if(businessUnitName!=null&&!acsUtils.isAuthority("iqc_all", ContextUtils.getUserId(), ContextUtils.getCompanyId())){
			  hql += " and o.processSection='"+businessUnitName+"' ";
	...
	public Page<IncomingInspectionActionsReport> listExceptionConfirm(Page<IncomingInspectionActionsReport> page,String checkItem){
		  ...
		  return searchPageByHql(page, hql,IncomingInspectionActionsReport.INPECTION_STATE_EXCEPTION_CONFIRM);
	}
	...
	public Page<IncomingInspectionActionsReport> unlist(Page<IncomingInspectionActionsReport> page){
		 String hql = "from IncomingInspectionActionsReport o where o.hiddenState = 'N' and o.isDelete='否' and o.inspectionConclusion=? and o.inspectionState=? ";
		  String businessUnitName = CommonUtil.getDataByLogin();
		  if(businessUnitName!=null&&!acsUtils.isAuthority("iqc_all", ContextUtils.getUserId(), ContextUtils.getCompanyId())){
			  hql += " and o.processSection='"+businessUnitName+"' ";
		  }
	...
	public Page<IncomingInspectionActionsReport> copylist(Page<IncomingInspectionActionsReport> page){
		 String hql = "from IncomingInspectionActionsReport o where  o.isDelete='否' and o.targetCopy='是' ";
		  String businessUnitName = CommonUtil.getDataByLogin();
		  if(businessUnitName!=null&&!acsUtils.isAuthority("iqc_all", ContextUtils.getUserId(), ContextUtils.getCompanyId())){
			  hql += " and o.processSection='"+businessUnitName+"' ";
		  }
	...
	public List<IncomingInspectionActionsReport> getAllIncomingInspectionActionsReport(){
		 String hql = "from IncomingInspectionActionsReport o where o.companyId=? and o.isDelete='否'";
	...
	public List<IncomingInspectionActionsReport> getSupplierAndCode(){
		String businessUnitName = CommonUtil.getDataByLogin();
		String hql = "select distinct i.supplierName,i.supplierCode,i.checkBomName,i.checkBomCode,i.processSection from IncomingInspectionActionsReport i where i.companyId=? ";
		if(businessUnitName!=null&&"欧菲-TP".equals(ContextUtils.getCompanyName())){
			hql += " and i.processSection='"+businessUnitName+"' ";
		}	
		hql += " and i.isDelete='否' ";
		Query query = this.getSession().createQuery(hql);
		query.setParameter(0, ContextUtils.getCompanyId());
		return query.list();
	}
	...
	public List<IncomingInspectionActionsReport> listAllForm(){
		return find("from IncomingInspectionActionsReport i where i.companyId=?", ContextUtils.getCompanyId());
	}
...
//		hql += " group by i.inspectionNo";
	...
	public Page<IncomingInspectionActionsReport> listHid(Page<IncomingInspectionActionsReport> page){
		  String hql = "from IncomingInspectionActionsReport o where o.hiddenState = 'Y' and o.isDelete = '否' and o.sourceId is null ";
		  String businessUnitName = CommonUtil.getDataByLogin();
		  if(businessUnitName!=null&&!acsUtils.isAuthority("iqc_all", ContextUtils.getUserId(), ContextUtils.getCompanyId())){
			  hql += " and o.processSection='"+businessUnitName+"' ";
		  }
	...
	public Page<IncomingInspectionActionsReport> listRecycle(Page<IncomingInspectionActionsReport> page){
		  String hql = "from IncomingInspectionActionsReport o where  o.isDelete = '是' ";
		  String businessUnitName = CommonUtil.getDataByLogin();
		  if(businessUnitName!=null&&!acsUtils.isAuthority("iqc_all", ContextUtils.getUserId(), ContextUtils.getCompanyId())){
			  hql += " and o.processSection='"+businessUnitName+"' ";
		  }
	...
	public List<IncomingInspectionActionsReport> listRecycleAll() {
		String hql = "from IncomingInspectionActionsReport o where o.companyId = ? and  o.isDelete = '是' ";
		return this.find(hql, new Object[]{ContextUtils.getCompanyId()});
	}
	
	public List<IncomingInspectionActionsReport> listOutOrIn() {
		  String hql = "from IncomingInspectionActionsReport o where o.companyId = ? and  (o.supplierCodeOut is not null or  o.supplierCodeIn is not null or o.checkBomNameIn is not null or o.checkBomNameOut is not null ) ";
		  String businessUnitName = CommonUtil.getDataByLogin();
		  if(businessUnitName!=null&&!acsUtils.isAuthority("iqc_all", ContextUtils.getUserId(), ContextUtils.getCompanyId())){
			  hql += " and o.processSection='"+businessUnitName+"' ";
		  }
