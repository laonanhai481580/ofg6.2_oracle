...
public class SampleTransferAction extends CrudActionSupport<SampleTransferRecord> {
	...
	protected void prepareModel() throws Exception {
		if(id==null){
			...
			sampleTransferRecord.setBusinessUnitCode(CommonUtil.getBusinessUnitCode(ContextUtils.getCompanyName()));
		}else {
	...
	public String save() throws Exception {
		try {
			...
			sampleTransferRecord.setBusinessUnitName(businessUnitName);
