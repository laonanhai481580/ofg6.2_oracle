...
public class SampleC1051CodeLetterManager {
	...
	public AcceptanceQualityLimit queryQualityLimit(Integer checkAmount,String aql,Long companyId){
		...
		String hql = "select s from SampleC1051Scheme s where s.companyId = ? and s.aql = ? and  "+
		" (? between s.sampleC1051CodeLetter.batchSize1 and s.sampleC1051CodeLetter.batchSize2  or (s.sampleC1051CodeLetter.batchSize1 is null and s.sampleC1051CodeLetter.batchSize2 >= ?) or (s.sampleC1051CodeLetter.batchSize2 is null and s.sampleC1051CodeLetter.batchSize1 <= ?))";
		List<SampleC1051Scheme> sampleC1051Schemes = sampleC1051CodeLetterDao.find(hql,companyId,aql,checkAmount,checkAmount,checkAmount);
