 ...
 *
 */
@Namespace("/iqc/sample-standard/count-sample")
@ParentPackage("default")
@Results({ @Result(name = CrudActionSupport.RELOAD, location = "iqc/sample-standard/count-sample", type = "redirectAction") })
public class CountSamplePlanAction extends CrudActionSupport<SampleScheme> {
	...
	protected void prepareModel() throws Exception {
		if(id == null){
			...
			sampleScheme.setCountType(SampleScheme.COUNT_TYPE);
			...
			sampleScheme.setBusinessUnitCode(CommonUtil.getBusinessUnitCode(ContextUtils.getCompanyName()));
		}else{
	...
	public String save() throws Exception {
		...
		try {
			...
			//加严
			List<SampleScheme> sampleSchemes = sampleSchemeManager.querySampleScheme(sampleScheme.getBaseType(),SampleScheme.TIGHTEN_TYPE,sampleScheme.getCode(),SampleScheme.COUNT_TYPE);
			if(!sampleSchemes.isEmpty()){
				jsonObject.put("params.tighten",sampleSchemes.get(0).getAmount());
			}
			//减量
			sampleSchemes = sampleSchemeManager.querySampleScheme(sampleScheme.getBaseType(),SampleScheme.RELAX_TYPE,sampleScheme.getCode(),SampleScheme.COUNT_TYPE);
			if(!sampleSchemes.isEmpty()){
	...
	@Action("mil-list")
	public String milList() throws Exception {
		//拼接列表
		StringBuffer colNamesByAql = new StringBuffer();
		String[] mitAqls = SampleScheme.getMitAQLs();
		List<String> columns = new ArrayList<String>();
	...
	public String getListDatas() throws Exception {
		try {
			page = sampleSchemeManager.getListDatasByCountType(page,SampleScheme.ORDINARY_TYPE,SampleCodeLetter.MIL_TYPE,SampleScheme.COUNT_TYPE);
			this.renderText(PageUtils.dynamicPageToJson(page,new DynamicColumnValues(){
				public void addValuesTo(List<Map<String, Object>> result) {
					for(Map<String, Object> map : result){
						...
						//加严
						List<SampleScheme> sampleSchemes = sampleSchemeManager.querySampleScheme(SampleCodeLetter.MIL_TYPE,SampleScheme.TIGHTEN_TYPE,sampleScheme.getCode(),SampleScheme.COUNT_TYPE);
						if(!sampleSchemes.isEmpty()){
							map.put("params.tighten",sampleSchemes.get(0).getAmount());
						}
						//减量
						sampleSchemes = sampleSchemeManager.querySampleScheme(SampleCodeLetter.MIL_TYPE,SampleScheme.RELAX_TYPE,sampleScheme.getCode(),SampleScheme.COUNT_TYPE);
						if(!sampleSchemes.isEmpty()){
	...
	@Action("tp-list-datas")
	public String getTpListDatas() throws Exception {
		try {
			page = sampleSchemeManager.getListDatasByCountType(page,SampleScheme.ORDINARY_TYPE,SampleCodeLetter.ANSI_TYPE,SampleScheme.COUNT_TYPE);
			this.renderText(PageUtils.dynamicPageToJson(page,new DynamicColumnValues(){
				public void addValuesTo(List<Map<String, Object>> result) {
					for(Map<String, Object> map : result){
						Long id = Long.valueOf(map.get("id").toString());
						...
						//加严
						List<SampleScheme> sampleSchemes = sampleSchemeManager.querySampleScheme(SampleCodeLetter.ANSI_TYPE,SampleScheme.TIGHTEN_TYPE,sampleScheme.getCode(),SampleScheme.COUNT_TYPE);
						if(!sampleSchemes.isEmpty()){
							map.put("params.tighten",sampleSchemes.get(0).getAmount());
						}
						//减量
						sampleSchemes = sampleSchemeManager.querySampleScheme(SampleCodeLetter.ANSI_TYPE,SampleScheme.RELAX_TYPE,sampleScheme.getCode(),SampleScheme.COUNT_TYPE);
						if(!sampleSchemes.isEmpty()){
							map.put("params.relax",sampleSchemes.get(0).getAmount());
						}
					}
	...
	@Action("mil-list-datas")
	public String getMilListDatas() throws Exception {
		try {
			page = sampleSchemeManager.getListDatasByCountType(page,SampleScheme.ORDINARY_TYPE,SampleCodeLetter.MIL105E_TYPE,SampleScheme.COUNT_TYPE);
			this.renderText(PageUtils.dynamicPageToJson(page,new DynamicColumnValues(){
				public void addValuesTo(List<Map<String, Object>> result) {
					for(Map<String, Object> map : result){
						Long id = Long.valueOf(map.get("id").toString());
						...
						//加严
						List<SampleScheme> sampleSchemes = sampleSchemeManager.querySampleScheme(SampleCodeLetter.MIL105E_TYPE,SampleScheme.TIGHTEN_TYPE,sampleScheme.getCode(),SampleScheme.COUNT_TYPE);
						if(!sampleSchemes.isEmpty()){
							map.put("params.tighten",sampleSchemes.get(0).getAmount());
						}
						//减量
						sampleSchemes = sampleSchemeManager.querySampleScheme(SampleCodeLetter.MIL105E_TYPE,SampleScheme.RELAX_TYPE,sampleScheme.getCode(),SampleScheme.COUNT_TYPE);
						if(!sampleSchemes.isEmpty()){
							map.put("params.relax",sampleSchemes.get(0).getAmount());
						}
					}
