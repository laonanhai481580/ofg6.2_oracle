...
public class MeasureSamplePlanAction extends CrudActionSupport<SampleScheme> {
	...
	public String save() throws Exception {
		...
		try {
			...
			//加严
			List<SampleScheme> sampleSchemes = sampleSchemeManager.querySampleScheme(sampleScheme.getBaseType(),SampleScheme.TIGHTEN_TYPE,sampleScheme.getCode(),SampleScheme.MEASURE_TYPE);
			if(!sampleSchemes.isEmpty()){
				jsonObject.put("params.tighten",sampleSchemes.get(0).getAmount());
			}
			//减量
			sampleSchemes = sampleSchemeManager.querySampleScheme(sampleScheme.getBaseType(),SampleScheme.RELAX_TYPE,sampleScheme.getCode(),SampleScheme.MEASURE_TYPE);
			if(!sampleSchemes.isEmpty()){
	...
	public String getTpListDatas() throws Exception {
		try {
			page = sampleSchemeManager.getListDatasByCountType(page,SampleScheme.ORDINARY_TYPE,SampleCodeLetter.ANSI_TYPE,SampleScheme.MEASURE_TYPE);
			this.renderText(PageUtils.dynamicPageToJson(page,new DynamicColumnValues(){
				public void addValuesTo(List<Map<String, Object>> result) {
					for(Map<String, Object> map : result){
						Long id = Long.valueOf(map.get("id").toString());
						...
						//加严
						List<SampleScheme> sampleSchemes = sampleSchemeManager.querySampleScheme(SampleCodeLetter.ANSI_TYPE,SampleScheme.TIGHTEN_TYPE,sampleScheme.getCode(),SampleScheme.MEASURE_TYPE);
						if(!sampleSchemes.isEmpty()){
							map.put("params.tighten",sampleSchemes.get(0).getAmount());
						}
						//减量
						sampleSchemes = sampleSchemeManager.querySampleScheme(SampleCodeLetter.ANSI_TYPE,SampleScheme.RELAX_TYPE,sampleScheme.getCode(),SampleScheme.MEASURE_TYPE);
						if(!sampleSchemes.isEmpty()){
							map.put("params.relax",sampleSchemes.get(0).getAmount());
						}
					}
	...
	public String getMilListDatas() throws Exception {
		try {
			page = sampleSchemeManager.getListDatasByCountType(page,SampleScheme.ORDINARY_TYPE,SampleCodeLetter.MIL105E_TYPE,SampleScheme.MEASURE_TYPE);
			this.renderText(PageUtils.dynamicPageToJson(page,new DynamicColumnValues(){
				public void addValuesTo(List<Map<String, Object>> result) {
					for(Map<String, Object> map : result){
						Long id = Long.valueOf(map.get("id").toString());
						...
						//加严
						List<SampleScheme> sampleSchemes = sampleSchemeManager.querySampleScheme(SampleCodeLetter.MIL105E_TYPE,SampleScheme.TIGHTEN_TYPE,sampleScheme.getCode(),SampleScheme.MEASURE_TYPE);
						if(!sampleSchemes.isEmpty()){
							map.put("params.tighten",sampleSchemes.get(0).getAmount());
						}
						//减量
						sampleSchemes = sampleSchemeManager.querySampleScheme(SampleCodeLetter.MIL105E_TYPE,SampleScheme.RELAX_TYPE,sampleScheme.getCode(),SampleScheme.MEASURE_TYPE);
						if(!sampleSchemes.isEmpty()){
							map.put("params.relax",sampleSchemes.get(0).getAmount());
						}
					}
