 ...
 *
 */
@Namespace("/iqc/sample-standard/tighten-sample")
@ParentPackage("default")
@Results({ @Result(name = CrudActionSupport.RELOAD, location = "iqc/sample-standard/tighten-sample", type = "redirectAction") })
public class TightenSampleAction extends CrudActionSupport<SampleScheme> {
	...
	protected void prepareModel() throws Exception {
		if(id == null){
			...
			sampleScheme.setType(SampleScheme.TIGHTEN_TYPE);
	...
	public String getListDatas() throws Exception {
		try {
			page = sampleSchemeManager.getListDatas(page,SampleCodeLetter.GB_TYPE,SampleScheme.TIGHTEN_TYPE);
		...
		logUtilDao.debugLog("查询", "进货检验管理：物料抽样标准维护-加严检验抽样维护");
		return null;
	}
	...
	public String getTpListDatas() throws Exception {
		try {
			page = sampleSchemeManager.getListDatas(page,SampleCodeLetter.ANSI_TYPE,SampleScheme.TIGHTEN_TYPE);
			this.renderText(PageUtils.dynamicPageToJson(page,new DynamicColumnValues(){
				public void addValuesTo(List<Map<String, Object>> result) {
					for(Map<String, Object> map : result){
						Long id = Long.valueOf(map.get("id").toString());
	...
	public String getMilListDatas() throws Exception {
		try {
			page = sampleSchemeManager.getListDatas(page,SampleCodeLetter.MIL105E_TYPE,SampleScheme.TIGHTEN_TYPE);
			this.renderText(PageUtils.dynamicPageToJson(page,new DynamicColumnValues(){
				public void addValuesTo(List<Map<String, Object>> result) {
					for(Map<String, Object> map : result){
						Long id = Long.valueOf(map.get("id").toString());
