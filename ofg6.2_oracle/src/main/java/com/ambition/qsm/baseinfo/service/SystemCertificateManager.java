...
public class SystemCertificateManager {
	...
	public Page<SystemCertificate> listState(Page<SystemCertificate> page,String state ,String str){
		String hql = " from SystemCertificate e where e.hiddenState=? ";
		...
		return systemCertificateDao.searchPageByHql(page, hql, searchParams.toArray());
	}
