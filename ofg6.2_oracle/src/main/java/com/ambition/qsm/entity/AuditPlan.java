...
public class AuditPlan extends WorkflowIdEntity{
	...
	private String auditFile1;//检查表不符合
	private String auditFile2;//会议记录
//	private String auditFile3;//
	...
	private String copyMan;//抄送人 **用于发送邮件
	...
	public String getAuditFile1() {
		return auditFile1;
	}
	public void setAuditFile1(String auditFile1) {
		this.auditFile1 = auditFile1;
	}
	public String getAuditFile2() {
		return auditFile2;
	}
	public void setAuditFile2(String auditFile2) {
