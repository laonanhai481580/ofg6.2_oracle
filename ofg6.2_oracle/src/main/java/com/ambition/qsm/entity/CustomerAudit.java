...
public class CustomerAudit extends IdEntity{
	...
	private String textQpa;//QPA/QSA
	private String textQsa;//质量体系稽核
	private String issuesId;//履历Id
	private String issuesFormNo;//履历单号
	...
	public String getTextQpa() {
		return textQpa;
	}
	public void setTextQpa(String textQpa) {
		this.textQpa = textQpa;
	}
	public String getTextQsa() {
		return textQsa;
	}
	public void setTextQsa(String textQsa) {
		this.textQsa = textQsa;
	}
	...
	public String getIssuesFormNo() {
		return issuesFormNo;
	}
	public void setIssuesFormNo(String issuesFormNo) {
		this.issuesFormNo = issuesFormNo;
	}
