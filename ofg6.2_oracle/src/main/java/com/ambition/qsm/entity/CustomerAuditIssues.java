...
public class CustomerAuditIssues extends WorkflowIdEntity{
	...
	private String problemFile;//问题描述附件
	...
	private String isShouDong;//是否手动关闭
	private String shouDongLogin;//手动关闭账号
	@Column(length=1000)
	private String improveEffect;//改善效果
	private String remark;//备注
	private String manageNo;//管理编号
	private String customerId;//履历ID
	...
	public String getShouDongLogin() {
		return shouDongLogin;
	}
	public void setShouDongLogin(String shouDongLogin) {
		this.shouDongLogin = shouDongLogin;
	}
