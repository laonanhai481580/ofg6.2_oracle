...
public class ManageReviewManager extends AmbWorkflowManagerBase<ManageReview>{
	...
	public String deleteEntity(String ids) {
		...
		for (String id : deleteIds) {
			ManageReview report=getEntity(Long.valueOf(id));
			deleteEntity(report);
	...
	public Page<ManageReview> listState(Page<ManageReview> page,String state ,String str){
		String hql = " from ManageReview e where e.hiddenState=? and e.companyId=?";
		...
		return manageReviewDao.searchPageByHql(page, hql, searchParams.toArray());
	}
}
