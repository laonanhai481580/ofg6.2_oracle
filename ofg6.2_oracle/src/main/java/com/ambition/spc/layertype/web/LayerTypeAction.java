...
public class LayerTypeAction extends com.ambition.product.base.CrudActionSupport<LayerType> {
	...
	private Page<LayerDetail> page;
	private Page<LayerDetail> pageDetail;
	...
	public Page<LayerDetail> getPage() {
		return page;
	}

	public void setPage(Page<LayerDetail> page) {
		this.page = page;
	}
	...
	public Page<LayerDetail> getPageDetail() {
		return pageDetail;
	}

	public void setPageDetail(Page<LayerDetail> pageDetail) {
	...
	public String detailListData() throws Exception {
		...
		try {
			...
			String pageCount=Struts2Utils.getParameter("pageCount");
			pageDetail = layerTypeManager.listByType(page,layerType);
			this.renderText(PageUtils.pageToJson(pageDetail));
		} catch (Exception e) {
			e.printStackTrace();
		}
		return null;
