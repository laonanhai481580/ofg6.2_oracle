...
public class ProcessDefineManager {
	...
	private Boolean isExistProcessPoint(Long id,String code,ProcessPoint parent){
	...
	public void saveProcessPoint(ProcessPoint processPoint){
		...
		if(isExistProcessPoint(processPoint.getId(),processPoint.getCode(),processPoint.getParent())){
	...
	public void copyPointInfo(ProcessPoint processPoint, ProcessPoint copyPoint) {
		...
		processPoint.setParentIds(copyPoint.getParentIds());
