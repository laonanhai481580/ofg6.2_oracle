	...
	public String dataAnalysis() throws Exception {
		...
		if(featureId!=null&&!featureId.equals("")){
			...
			if(qualityFeature!=null){
				//ActionContext.getContext().put("featureId",qualityFeature.getId());
				ActionContext.getContext().put("featureName",qualityFeature.getName());
				featureName=qualityFeature.getName();
			}
...
//		featureId = "17";
	...
	public String getLayersByFeature() throws Exception{
		...
		if(StringUtils.isNotEmpty(featureId)&&CommonUtil.isInteger(featureId)){
