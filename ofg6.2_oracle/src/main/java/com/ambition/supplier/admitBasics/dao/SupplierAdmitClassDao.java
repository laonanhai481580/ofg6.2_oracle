...
public class SupplierAdmitClassDao extends HibernateDao<SupplierAdmitClass,Long>{
	...
	public Page<SupplierAdmitClass> listPage(Page<SupplierAdmitClass> page){
		return searchPageByHql(page,"from SupplierAdmitClass d where d.companyId=?  ",ContextUtils.getCompanyId());
	}
