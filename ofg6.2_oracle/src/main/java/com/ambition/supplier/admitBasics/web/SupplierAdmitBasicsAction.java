...
public class SupplierAdmitBasicsAction extends BaseAction<SupplierAdmitBasics>{
	...
	public Long getAdmitClassId() {
		return admitClassId;
	}

	public void setAdmitClassId(Long admitClassId) {
...
//		}
	...
	public String getListStates() throws Exception {
		...
		try {
			if(materialSort!=null){
				...
				page = admitBasicsManager.getCodeByParams(page, materialSort);
			}
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public String downloadTemplate() throws Exception {
		...
		try {
			inputStream = this.getClass().getClassLoader().getResourceAsStream("template/report/supplier-admit-basics.xlsx");
