...
public class SupplierDevelopManager extends AmbWorkflowManagerBase<SupplierDevelop>{
   ...
   public void deleteEntity(SupplierDevelop entity){
	...
	public Page<SupplierDevelop> listState(Page<SupplierDevelop> page,String state){
		String hql = " from SupplierDevelop e where e.developState=?";
		return supplierDevelopDao.searchPageByHql(page, hql, state);
	}
}
