...
public class SupplierAbnormal  extends IdEntity{
	...
	@OneToMany(mappedBy = "supplierAbnormal",cascade={javax.persistence.CascadeType.ALL})
    @Cascade(org.hibernate.annotations.CascadeType.DELETE_ORPHAN)
	@JsonIgnore
	List<SupplierAbnormalItem> SupplierAbnormalItems;//不良明细
	...
	public List<SupplierAbnormalItem> getSupplierAbnormalItems() {
		return SupplierAbnormalItems;
	}

	public void setSupplierAbnormalItems(
			List<SupplierAbnormalItem> supplierAbnormalItems) {
