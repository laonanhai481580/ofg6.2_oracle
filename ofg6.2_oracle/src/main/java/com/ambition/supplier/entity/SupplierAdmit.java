...
public class SupplierAdmit extends WorkflowIdEntity{
	 ...
	 * 会签
	 */
	private String againSign;//是否为再次会签
	...
	private String oeChecker;//OE核准
	private String oeCheckerLog;//OE核准登录名
	...
	private String countersignOE;//会签意见OE
	...
	private String fileEE;//EE附件
	private String fileOE;//OE附件
	...
	private String showGpMaterialNo;//显示产品宣告编号
	private String showGpMaterialState;//显示产品宣告状态
	private String showGpMaterialId;//显示产品宣告Id
	...
	public String getShowGpMaterialNo() {
		return showGpMaterialNo;
	}
	public void setShowGpMaterialNo(String showGpMaterialNo) {
		this.showGpMaterialNo = showGpMaterialNo;
	}
	public String getShowGpMaterialState() {
		return showGpMaterialState;
	}
	public void setShowGpMaterialState(String showGpMaterialState) {
		this.showGpMaterialState = showGpMaterialState;
	}
	public String getShowGpMaterialId() {
		return showGpMaterialId;
	}
	public void setShowGpMaterialId(String showGpMaterialId) {
		this.showGpMaterialId = showGpMaterialId;
	}
	...
	public String getOeChecker() {
		return oeChecker;
	}
	public void setOeChecker(String oeChecker) {
		this.oeChecker = oeChecker;
	}
	public String getOeCheckerLog() {
		return oeCheckerLog;
	}
	public void setOeCheckerLog(String oeCheckerLog) {
		this.oeCheckerLog = oeCheckerLog;
	}
	...
	public String getCountersignOE() {
		return countersignOE;
	}
	public void setCountersignOE(String countersignOE) {
		this.countersignOE = countersignOE;
	}
	public String getFileOE() {
		return fileOE;
	}
	public void setFileOE(String fileOE) {
		this.fileOE = fileOE;
	}
