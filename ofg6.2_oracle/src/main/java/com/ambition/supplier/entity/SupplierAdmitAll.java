 ...
 */
@Entity
@Table(name="SUPPLIER_SUPPLIER_ADMIT_ALL")
public class SupplierAdmitAll extends WorkflowIdEntity{
	
	private static final long serialVersionUID = 1L;
	public static final String ENTITY_LIST_CODE = "SUPPLIER_SUPPLIER_ADMIT_ALL";//实体编码
	public static final String ENTITY_LIST_NAME = "材料承认管理汇总";//实体名称
	/*材料承认发起 */
	 ...
	 * 附件上传
	 */
	@OneToMany(mappedBy = "supplierAdmitAll",cascade={CascadeType.ALL})
    //@Cascade(org.hibernate.annotations.CascadeType.DELETE_ORPHAN)
	@JsonIgnore
	private List<SupplierAdmitFileAll> supplierAdmitFiles;
	...
	public List<SupplierAdmitFileAll> getSupplierAdmitFiles() {
		return supplierAdmitFiles;
	}
	public void setSupplierAdmitFiles(List<SupplierAdmitFileAll> supplierAdmitFiles) {
