...
//	private String supplierEvaluateDept;//评估部门(厂商)
	...
	private String rdIfTest;//RD是否试做
	...
	private String npiProcesser;//npi办理人
	private String npiProcesserLog;//npi办理人登录名
	private String npiOpinion;//npi建议与评述
	private String npiFile;//npi附件
	private String qsIfTest;//是否试做
	private String npiIfTest;//是否试做
	...
	public String getNpiProcesser() {
		return npiProcesser;
	}
	public void setNpiProcesser(String npiProcesser) {
		this.npiProcesser = npiProcesser;
	}
	public String getNpiProcesserLog() {
		return npiProcesserLog;
	}
	public void setNpiProcesserLog(String npiProcesserLog) {
		this.npiProcesserLog = npiProcesserLog;
	}
	public String getNpiOpinion() {
		return npiOpinion;
	}
	public void setNpiOpinion(String npiOpinion) {
		this.npiOpinion = npiOpinion;
	}
	public String getNpiFile() {
		return npiFile;
	}
	public void setNpiFile(String npiFile) {
		this.npiFile = npiFile;
	}
	public String getQsIfTest() {
		return qsIfTest;
	}
	public void setQsIfTest(String qsIfTest) {
		this.qsIfTest = qsIfTest;
	}
	public String getNpiIfTest() {
		return npiIfTest;
	}
	public void setNpiIfTest(String npiIfTest) {
		this.npiIfTest = npiIfTest;
	}
