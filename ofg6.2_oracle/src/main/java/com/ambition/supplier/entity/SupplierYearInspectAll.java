 ...
 */
@Entity
@Table(name="SUPPLIER_YEAR_INSPECT_ALL")
@JsonIgnoreProperties(value={"hibernateLazyInitializer","handler","fieldHandler"})
public class SupplierYearInspectAll extends WorkflowIdEntity{
	private static final long serialVersionUID = 1L;
	public static final String ENTITY_LIST_CODE = "SUPPLIER_YEAR_INSPECT_ALL";//实体编码
	public static final String ENTITY_LIST_NAME = "供应商稽核报告2.0汇总";//实体名称
