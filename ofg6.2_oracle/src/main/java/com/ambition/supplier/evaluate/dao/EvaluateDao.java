...
public class EvaluateDao extends HibernateDao<Evaluate, Long> {
	...
	public Page<Evaluate> search(Page<Evaluate> page,Long supplierId,Long modelId){
		String hql = "from Evaluate e where e.companyId = ? and e.supplierId = ? and e.modelId=? ";
		return searchPageByHql(page,hql,new Object[]{ContextUtils.getCompanyId(),supplierId,modelId});
	}
	...
	public Evaluate findEvaluateBySupplerAndYearMonthAndCycle(Supplier supplier,Integer year,Integer month,Long estimateModelId,String materialType,String cycle){
		String businessUnitCode  = CommonUtil.getBusinessUnitCode(ContextUtils.getCompanyName());
